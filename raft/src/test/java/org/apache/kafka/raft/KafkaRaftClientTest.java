...
public class KafkaRaftClientTest {
    ...
    public void testInitializeAsLeaderFromStateStoreSingleMemberQuorum() throws Exception {
        ...
        assertEquals(new LeaderAndEpoch(OptionalInt.of(localId), initialEpoch + 1), context.currentLeaderAndEpoch());
    ...
    public void testRejectVotesFromSameEpochAfterResigningLeadership() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).updateRandom(r -> r.mockNextInt(DEFAULT_ELECTION_TIMEOUT_MS, 0)).withElectedLeader(epoch, localId).build();
        ...
        context.deliverRequest(context.voteRequest(epoch, remoteId, context.log.lastFetchedEpoch(), context.log.endOffset().offset));
    ...
    public void testRejectVotesFromSameEpochAfterResigningCandidacy() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).updateRandom(r -> r.mockNextInt(DEFAULT_ELECTION_TIMEOUT_MS, 0)).withVotedCandidate(epoch, localId).build();
    ...
    public void testGrantVotesFromHigherEpochAfterResigningLeadership() throws Exception {
        ...
        context.deliverRequest(context.voteRequest(epoch + 1, remoteId, context.log.lastFetchedEpoch(), context.log.endOffset().offset));
        context.client.poll();
    ...
    public void testAppendFailedWithNotLeaderException() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withUnknownLeader(epoch).build();
    ...
    public void testAppendFailedWithBufferAllocationException() throws Exception {
        ...
        Mockito.when(memoryPool.tryAllocate(KafkaRaftClient.MAX_BATCH_SIZE_BYTES)).thenReturn(null);
        Mockito.when(memoryPool.tryAllocate(256)).thenReturn(leaderBuffer);

        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withMemoryPool(memoryPool).build();
    ...
    public void testEndQuorumEpochRetriesWhileResigned() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withElectionTimeoutMs(10000).withRequestTimeoutMs(5000).withElectedLeader(epoch, localId).build();

        context.pollUntilRequest();
        List<RaftRequest.Outbound> requests = context.collectEndQuorumRequests(epoch, Utils.mkSet(voter1, voter2), Optional.empty());
        ...
        context.deliverResponse(endEpochOutbound.correlationId, endEpochOutbound.destinationId(), context.endEpochResponse(epoch, OptionalInt.of(localId)));
        context.client.poll();
        ...
        context.pollUntilRequest();
        List<RaftRequest.Outbound> retries = context.collectEndQuorumRequests(epoch, Utils.mkSet(nonRespondedId), Optional.empty());
    ...
    public void testResignWillCompleteFetchPurgatory() throws Exception {
        ...
        context.log.appendAsLeader(context.buildBatch(context.log.endOffset().offset, epoch, singletonList("raft")), epoch);
    ...
    public void testHandleBeginQuorumEpochAfterUserInitiatedResign() throws Exception {
        ...
        assertEquals(new LeaderAndEpoch(OptionalInt.of(remoteId1), resignedEpoch + 1), context.listener.currentLeaderAndEpoch());
    }
    ...
    public void testCannotResignWithLargerEpochThanCurrentEpoch() throws Exception {
        ...
        assertThrows(IllegalArgumentException.class, () -> context.client.resign(context.currentEpoch() + 1));
    }
    ...
    public void testCannotResignIfNotLeader() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withElectedLeader(leaderEpoch, otherNodeId).build();
    ...
    public void testCannotResignIfObserver() throws Exception {
        ...
        context.deliverResponse(fetchRequest.correlationId, fetchRequest.destinationId(), context.fetchResponse(epoch, leaderId, MemoryRecords.EMPTY, 0L, Errors.FENCED_LEADER_EPOCH));
    ...
    public void testInitializeAsCandidateFromStateStore() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withVotedCandidate(2, localId).build();
    ...
    public void testHandleBeginQuorumRequest() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withVotedCandidate(votedCandidateEpoch, otherNodeId).build();
    ...
    public void testHandleBeginQuorumResponse() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withElectedLeader(leaderEpoch, localId).build();
    ...
    public void testEndQuorumIgnoredAsCandidateIfOlderEpoch() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).updateRandom(r -> r.mockNextInt(jitterMs)).withUnknownLeader(epoch - 1).build();
        ...
        context.deliverRequest(context.endEpochRequest(epoch - 2, otherNodeId, Collections.singletonList(localId)));
    ...
    public void testEndQuorumStartsNewElectionImmediatelyIfFollowerUnattached() throws Exception {
        ...
        context.deliverRequest(context.endEpochRequest(epoch, voter2, Arrays.asList(localId, voter3)));
    ...
    public void testAccumulatorClearedAfterBecomingFollower() throws Exception {
        ...
        ByteBuffer leaderBuffer = ByteBuffer.allocate(256);
        Mockito.when(memoryPool.tryAllocate(KafkaRaftClient.MAX_BATCH_SIZE_BYTES)).thenReturn(buffer);
        Mockito.when(memoryPool.tryAllocate(256)).thenReturn(leaderBuffer);

        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withAppendLingerMs(lingerMs).withMemoryPool(memoryPool).build();
    ...
    public void testAccumulatorClearedAfterBecomingVoted() throws Exception {
        ...
        assertEquals(1L, context.client.scheduleAppend(epoch, singletonList("a")));
        context.deliverRequest(context.voteRequest(epoch + 1, otherNodeId, epoch, context.log.endOffset().offset));
        context.pollUntilResponse();
    ...
    public void testChannelWokenUpIfLingerTimeoutReachedWithoutAppend() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withAppendLingerMs(lingerMs).build();
    ...
    public void testHandleEndQuorumRequest() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withElectedLeader(leaderEpoch, oldLeaderId).build();

        context.deliverRequest(context.endEpochRequest(leaderEpoch, oldLeaderId, Collections.singletonList(localId)));
    ...
    public void testHandleEndQuorumRequestWithLowerPriorityToBecomeLeader() throws Exception {
        ...
        context.deliverRequest(context.endEpochRequest(leaderEpoch, oldLeaderId, Arrays.asList(preferredNextLeader, localId)));
    ...
    public void testHandleVoteRequestAsFollowerWithElectedLeader() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withElectedLeader(epoch, electedLeaderId).build();
    ...
    public void testHandleVoteRequestAsFollowerWithVotedCandidate() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withVotedCandidate(epoch, votedCandidateId).build();
    ...
    public void testCandidateIgnoreVoteRequestOnSameEpoch() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withVotedCandidate(leaderEpoch, localId).build();
    ...
    public void testRetryElection() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).updateRandom(r -> r.mockNextInt(exponentialFactor)).build();
    ...
    public void testInitializeAsFollowerNonEmptyLog() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withElectedLeader(epoch, otherNodeId).appendToLog(lastEpoch, singletonList("foo")).build();
    ...
    public void testObserverQuorumDiscoveryFailure() throws Exception {
        ...
        context.deliverResponse(fetchRequest.correlationId, fetchRequest.destinationId(), context.fetchResponse(-1, -1, MemoryRecords.EMPTY, -1, Errors.UNKNOWN_SERVER_ERROR));
        context.client.poll();
    ...
    public void testInvalidFetchRequest() throws Exception {
        ...
        context.deliverRequest(context.fetchRequest(epoch, otherNodeId, -5L, 0, 0));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.INVALID_REQUEST, epoch, OptionalInt.of(localId));

        context.deliverRequest(context.fetchRequest(epoch, otherNodeId, 0L, -1, 0));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.INVALID_REQUEST, epoch, OptionalInt.of(localId));

        context.deliverRequest(context.fetchRequest(epoch, otherNodeId, 0L, epoch + 1, 0));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.INVALID_REQUEST, epoch, OptionalInt.of(localId));

        context.deliverRequest(context.fetchRequest(epoch + 1, otherNodeId, 0L, 0, 0));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.UNKNOWN_LEADER_EPOCH, epoch, OptionalInt.of(localId));

        context.deliverRequest(context.fetchRequest(epoch, otherNodeId, 0L, 0, -1));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.INVALID_REQUEST, epoch, OptionalInt.of(localId));
    }
    ...
    public void testFetchRequestClusterIdValidation() throws Exception {
        ...
        context.deliverRequest(context.fetchRequest(epoch, context.clusterId.toString(), otherNodeId, -5L, 0, 0));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.INVALID_REQUEST, epoch, OptionalInt.of(localId));

        // null cluster id is accepted
        context.deliverRequest(context.fetchRequest(epoch, null, otherNodeId, -5L, 0, 0));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.INVALID_REQUEST, epoch, OptionalInt.of(localId));
        ...
        context.deliverRequest(context.fetchRequest(epoch, "invalid-uuid", otherNodeId, -5L, 0, 0));
        context.pollUntilResponse();
        context.assertSentFetchPartitionResponse(Errors.INCONSISTENT_CLUSTER_ID);
    }
    ...
    public void testObserverLeaderRediscoveryAfterBrokerNotAvailableError() throws Exception {
        ...
        context.deliverResponse(fetchRequest1.correlationId, fetchRequest1.destinationId(), context.fetchResponse(epoch, -1, MemoryRecords.EMPTY, -1, Errors.BROKER_NOT_AVAILABLE));
        context.pollUntilRequest();
        ...
        context.deliverResponse(fetchRequest2.correlationId, fetchRequest2.destinationId(), context.fetchResponse(epoch, leaderId, MemoryRecords.EMPTY, 0L, error));
        context.client.poll();
    ...
    public void testObserverLeaderRediscoveryAfterRequestTimeout() throws Exception {
        ...
        context.deliverResponse(fetchRequest2.correlationId, fetchRequest2.destinationId(), context.fetchResponse(epoch, leaderId, MemoryRecords.EMPTY, 0L, Errors.FENCED_LEADER_EPOCH));
        context.client.poll();
    ...
    public void testEndQuorumEpochSentBasedOnFetchOffset() throws Exception {
        ...
        context.collectEndQuorumRequests(epoch, Utils.mkSet(closeFollower, laggingFollower), Optional.of(Arrays.asList(closeFollower, laggingFollower)));
    }
    ...
    public void testDescribeQuorum() throws Exception {
        ...
        context.assertSentDescribeQuorumResponse(localId, epoch, 3L, Arrays.asList(new ReplicaState().setReplicaId(localId)
                // As we are appending the records directly to the log,
                // the leader end offset hasn't been updated yet.
                .setLogEndOffset(3L).setLastFetchTimestamp(context.time.milliseconds()).setLastCaughtUpTimestamp(context.time.milliseconds()), new ReplicaState().setReplicaId(laggingFollower).setLogEndOffset(1L).setLastFetchTimestamp(laggingFollowerFetchTime).setLastCaughtUpTimestamp(laggingFollowerFetchTime), new ReplicaState().setReplicaId(closeFollower).setLogEndOffset(3L).setLastFetchTimestamp(closeFollowerFetchTime).setLastCaughtUpTimestamp(closeFollowerFetchTime)), singletonList(new ReplicaState().setReplicaId(observerId).setLogEndOffset(0L).setLastFetchTimestamp(observerFetchTime).setLastCaughtUpTimestamp(-1L)));
    }
    ...
    public void testObserverGracefulShutdown() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).withUnknownLeader(5).build();
        context.client.poll();
    ...
    public void testFetchShouldBeTreatedAsLeaderAcknowledgement() throws Exception {
        ...
        context.deliverRequest(context.fetchRequest(epoch, otherNodeId, 0L, 0, 500));
    ...
    public void testHandleClaimCallbackFiresAfterHighWatermarkReachesEpochStartOffset() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).appendToLog(1, batch1).appendToLog(1, batch2).appendToLog(2, batch3).withUnknownLeader(epoch - 1).build();
        ...
        assertEquals(OptionalLong.of(expectedBatches.stream().mapToInt(List::size).sum() - 1), context.listener.lastCommitOffset());
    }
    ...
    public void testHandleCommitCallbackFiresInVotedState() throws Exception {
        ...
        RaftClientTestContext context = new RaftClientTestContext.Builder(localId, voters).appendToLog(2, Arrays.asList("a", "b", "c")).appendToLog(4, Arrays.asList("d", "e", "f")).appendToLog(4, Arrays.asList("g", "h", "i")).withUnknownLeader(epoch - 1).build();
