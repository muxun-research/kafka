...
public class QuorumStateTest {
    ...
    private QuorumState buildQuorumState(OptionalInt localId, Set<Integer> voters) {
        return new QuorumState(localId, voters, electionTimeoutMs, fetchTimeoutMs, store, time, new LogContext(), random);
    }
    ...
    public void testInitializeAsUnattached() throws IOException {
        ...
        assertEquals(electionTimeoutMs + jitterMs, unattachedState.remainingElectionTimeMs(time.milliseconds()));
    }
    ...
    public void testInitializeAsVoted() throws IOException {
        ...
        assertEquals(electionTimeoutMs + jitterMs, votedState.remainingElectionTimeMs(time.milliseconds()));
    }
    ...
    public void testInitializeAsResignedCandidate() throws IOException {
        ...
        assertEquals(electionTimeoutMs + jitterMs, candidateState.remainingElectionTimeMs(time.milliseconds()));
    }
    ...
    public void testInitializeAsResignedLeader() throws IOException {
        ...
        assertEquals(electionTimeoutMs + jitterMs, resignedState.remainingElectionTimeMs(time.milliseconds()));
    }
    ...
    public void testCandidateToCandidate() throws IOException {
        ...
        assertEquals(electionTimeoutMs + jitterMs, candidate2.remainingElectionTimeMs(time.milliseconds()));
    }
    ...
    public void testLeaderToResigned() throws IOException {
        ...
        ResignedState resignedState = state.resignedStateOrThrow();
        assertEquals(ElectionState.withElectedLeader(1, localId, voters), resignedState.election());
    ...
    public void testUnattachedToUnattached() throws IOException {
        ...
        assertEquals(remainingElectionTimeMs - 1000, unattachedState.remainingElectionTimeMs(time.milliseconds()));
    }
    ...
    public void testInconsistentVotersBetweenConfigAndState() throws IOException {
        ...
        assertThrows(IllegalStateException.class, () -> state.initialize(new OffsetAndEpoch(0L, logEndEpoch)));
    }
