...
public final class ControlRecordTest {
    ...
    void testCtr() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new ControlRecord(ControlRecordType.ABORT, new SnapshotFooterRecord()));
        assertThrows(IllegalArgumentException.class, () -> new ControlRecord(ControlRecordType.LEADER_CHANGE, new SnapshotHeaderRecord()));
        assertThrows(IllegalArgumentException.class, () -> new ControlRecord(ControlRecordType.SNAPSHOT_FOOTER, Mockito.mock(ApiMessage.class)));
    }
