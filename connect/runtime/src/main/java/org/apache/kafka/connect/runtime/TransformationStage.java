...
public class TransformationStage<R extends ConnectRecord<R>> implements AutoCloseable {
    ...
    public Class<? extends Transformation<R>> transformClass() {
        @SuppressWarnings("unchecked") Class<? extends Transformation<R>> transformClass = (Class<? extends Transformation<R>>) transformation.getClass();
    ...
    public String toString() {
        return "TransformationStage{" + "predicate=" + predicate + ", transformation=" + transformation + ", negate=" + negate + '}';
    }
}
