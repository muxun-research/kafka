...
public class PluginInfo {
    ...
    @JsonCreator
    public PluginInfo(@JsonProperty("class") String className, @JsonProperty("type") PluginType type, @JsonProperty("version") String version) {
    ...
    public String toString() {
        return "PluginInfo{" + "className='" + className + '\'' + ", type=" + type.toString() + ", version='" + version + '\'' + '}';
    }
