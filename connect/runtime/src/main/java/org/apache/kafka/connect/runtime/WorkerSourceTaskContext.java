...
public class WorkerSourceTaskContext implements SourceTaskContext {
    ...
    public WorkerSourceTaskContext(OffsetStorageReader reader, ConnectorTaskId id, ClusterConfigState configState, WorkerTransactionContext transactionContext) {
        this.reader = reader;
        this.id = id;
