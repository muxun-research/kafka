...
public abstract class RestServerConfig extends AbstractConfig {
    ...
    public static void addPublicConfig(ConfigDef configDef) {
        ...
        configDef.define(REST_EXTENSION_CLASSES_CONFIG, ConfigDef.Type.LIST, "", ConfigDef.Importance.LOW, REST_EXTENSION_CLASSES_DOC).define(ADMIN_LISTENERS_CONFIG, ConfigDef.Type.LIST, null, new AdminListenersValidator(), ConfigDef.Importance.LOW, ADMIN_LISTENERS_DOC);
    }
