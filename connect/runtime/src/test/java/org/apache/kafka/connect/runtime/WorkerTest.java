...
public class WorkerTest {
    ...
    private void mockFileConfigProvider() {
        ...
        when(plugins.newConfigProvider(any(AbstractConfig.class), eq("config.providers.file"), any(ClassLoaderUsage.class))).thenReturn(mockFileConfigProvider);
    }
    ...
    public void testAddRemoveSourceTask() {
        ...
        worker = new Worker(WORKER_ID, new MockTime(), plugins, config, offsetBackingStore, executorService, noneConnectorClientConfigOverridePolicy, null);
        worker.herder = herder;
        worker.start();
    ...
    public void testConnectorStatusMetricsGroup_taskStatusCounter() {
        ...
        Worker.ConnectorStatusMetricsGroup metricGroup = new Worker.ConnectorStatusMetricsGroup(worker.metrics(), tasks, herder);
    ...
    public void testProducerConfigsWithoutOverrides() {
        ...
        assertEquals(expectedConfigs, Worker.baseProducerConfigs(CONNECTOR_ID, "connector-producer-" + TASK_ID, config, connectorConfig, null, noneConnectorClientConfigOverridePolicy, CLUSTER_ID));
    ...
    public void testProducerConfigsWithOverrides() {
        ...
        assertEquals(expectedConfigs, Worker.baseProducerConfigs(CONNECTOR_ID, "connector-producer-" + TASK_ID, configWithOverrides, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID));
        verify(connectorConfig).originalsWithPrefix(CONNECTOR_CLIENT_PRODUCER_OVERRIDES_PREFIX);
    }
    ...
    public void testConsumerConfigsWithoutOverrides() {
        ...
        assertEquals(expectedConfigs, Worker.baseConsumerConfigs(CONNECTOR_ID, "connector-consumer-" + TASK_ID, config, connectorConfig, null, noneConnectorClientConfigOverridePolicy, CLUSTER_ID, ConnectorType.SINK));
    }
    ...
    public void testConsumerConfigsWithOverrides() {
        ...
        assertEquals(expectedConfigs, Worker.baseConsumerConfigs(CONNECTOR_ID, "connector-consumer-" + TASK_ID, configWithOverrides, connectorConfig, null, noneConnectorClientConfigOverridePolicy, CLUSTER_ID, ConnectorType.SINK));
    ...
    public void testConsumerConfigsWithClientOverrides() {
        ...
        assertEquals(expectedConfigs, Worker.baseConsumerConfigs(CONNECTOR_ID, "connector-consumer-" + TASK_ID, configWithOverrides, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID, ConnectorType.SINK));
        verify(connectorConfig).originalsWithPrefix(ConnectorConfig.CONNECTOR_CLIENT_CONSUMER_OVERRIDES_PREFIX);
    }
    ...
    public void testConsumerConfigsClientOverridesWithNonePolicy() {
        ...
        assertThrows(ConnectException.class, () -> Worker.baseConsumerConfigs(CONNECTOR_ID, "connector-consumer-" + TASK_ID, configWithOverrides, connectorConfig, null, noneConnectorClientConfigOverridePolicy, CLUSTER_ID, ConnectorType.SINK));
        verify(connectorConfig).originalsWithPrefix(ConnectorConfig.CONNECTOR_CLIENT_CONSUMER_OVERRIDES_PREFIX);
    }
    ...
    public void testAdminConfigsClientOverridesWithAllPolicy() {
        ...
        assertEquals(expectedConfigs, Worker.adminConfigs(CONNECTOR_ID, "", configWithOverrides, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID, ConnectorType.SINK));
    ...
    public void testAdminConfigsClientOverridesWithNonePolicy() {
        ...
        assertThrows(ConnectException.class, () -> Worker.adminConfigs("test", "", configWithOverrides, connectorConfig, null, noneConnectorClientConfigOverridePolicy, CLUSTER_ID, ConnectorType.SINK));
        verify(connectorConfig).originalsWithPrefix(CONNECTOR_CLIENT_ADMIN_OVERRIDES_PREFIX);
    }
    ...
    public void testRegularSourceOffsetsConsumerConfigs() {
        ...
        Map<String, Object> consumerConfigs = Worker.regularSourceOffsetsConsumerConfigs("test", "", config, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID);
        ...
        config = new DistributedConfig(workerProps);
        consumerConfigs = Worker.regularSourceOffsetsConsumerConfigs("test", "", config, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID);
    ...
    public void testExactlyOnceSourceOffsetsConsumerConfigs() {
        ...
        Map<String, Object> consumerConfigs = Worker.exactlyOnceSourceOffsetsConsumerConfigs("test", "", config, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID);
        assertEquals("localhost:4761", consumerConfigs.get(BOOTSTRAP_SERVERS_CONFIG));
        assertEquals("read_committed", consumerConfigs.get(ISOLATION_LEVEL_CONFIG));
        ...
        workerProps.put("consumer." + ISOLATION_LEVEL_CONFIG, "read_uncommitted");
        config = new DistributedConfig(workerProps);
        consumerConfigs = Worker.exactlyOnceSourceOffsetsConsumerConfigs("test", "", config, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID);
        assertEquals("localhost:9021", consumerConfigs.get(BOOTSTRAP_SERVERS_CONFIG));
    ...
    public void testExactlyOnceSourceTaskProducerConfigs() {
        ...
        Map<String, Object> producerConfigs = Worker.exactlyOnceSourceTaskProducerConfigs(TASK_ID, config, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID);
        ...
        config = new DistributedConfig(workerProps);
        producerConfigs = Worker.exactlyOnceSourceTaskProducerConfigs(TASK_ID, config, connectorConfig, null, allConnectorClientConfigOverridePolicy, CLUSTER_ID);
    ...
    public void testOffsetStoreForRegularSourceTask() {
        ...
        @SuppressWarnings("unchecked") Producer<byte[], byte[]> producer = mock(Producer.class);
        ...
        assertTrue(connectorStore.hasWorkerGlobalStore());
        assertTrue(connectorStore.hasConnectorSpecificStore());
        assertThrows(NullPointerException.class, () -> worker.offsetStoreForRegularSourceTask(TASK_ID, sourceConfigWithOffsetsTopic, sourceConnector.getClass(), producer, producerProps, null));
        ...
        assertFalse(connectorStore.hasWorkerGlobalStore());
        assertTrue(connectorStore.hasConnectorSpecificStore());
        assertThrows(NullPointerException.class, () -> worker.offsetStoreForRegularSourceTask(TASK_ID, sourceConfigWithSameOffsetsTopicAsWorker, sourceConnector.getClass(), producer, producerProps, null));
    ...
    public void testZombieFencing() {
        ...
        worker = new Worker(WORKER_ID, new MockTime(), plugins, config, offsetBackingStore, executorService, allConnectorClientConfigOverridePolicy, mockAdminConstructor);
        worker.herder = herder;
        worker.start();
        ...
        KafkaFuture<Void> actualZombieFenceFuture = worker.fenceZombies(CONNECTOR_ID, 12, connectorConfig);

        assertEquals(expectedZombieFenceFuture, actualZombieFenceFuture);
        assertNotNull(adminConfig.get());
        assertEquals("Admin should be configured with user-specified overrides", "4761", adminConfig.get().get(RETRY_BACKOFF_MS_CONFIG));
    ...
    public void testGetSinkConnectorOffsets() throws Exception {
        ...
        Admin admin = mock(Admin.class);
        worker = new Worker(WORKER_ID, new MockTime(), plugins, config, offsetBackingStore, executorService, allConnectorClientConfigOverridePolicy, config -> admin);
        worker.start();
    ...
    public void testGetSourceConnectorOffsets() throws Exception {
        ...
        worker = new Worker(WORKER_ID, new MockTime(), plugins, config, offsetBackingStore, executorService, allConnectorClientConfigOverridePolicy, null);
        worker.start();

        Set<Map<String, Object>> connectorPartitions = Collections.singleton(Collections.singletonMap("partitionKey", "partitionValue"));

        Map<Map<String, Object>, Map<String, Object>> partitionOffsets = Collections.singletonMap(Collections.singletonMap("partitionKey", "partitionValue"), Collections.singletonMap("offsetKey", "offsetValue"));
    ...
    public void testAlterOffsetsConnectorDoesNotSupportOffsetAlteration() {
        ...
        mockInternalConverters();
        worker = new Worker(WORKER_ID, new MockTime(), plugins, config, offsetBackingStore, Executors.newSingleThreadExecutor(), allConnectorClientConfigOverridePolicy, null);
        worker.start();
        ...
        when(sourceConnector.alterOffsets(eq(connectorProps), anyMap())).thenThrow(new UnsupportedOperationException("This connector doesn't " + "support altering of offsets"));

        FutureCallback<Message> cb = new FutureCallback<>();
        worker.modifyConnectorOffsets(CONNECTOR_ID, connectorProps, Collections.singletonMap(Collections.singletonMap("partitionKey", "partitionValue"), Collections.singletonMap("offsetKey", "offsetValue")), cb);

        ExecutionException e = assertThrows(ExecutionException.class, () -> cb.get(1000, TimeUnit.MILLISECONDS));
        assertEquals(ConnectException.class, e.getCause().getClass());
        assertEquals("Failed to modify offsets for connector " + CONNECTOR_ID + " because it doesn't support external modification of offsets", e.getCause().getMessage());
    ...
    public void testAlterOffsetsSourceConnector() throws Exception {
        ...
        FutureCallback<Message> cb = new FutureCallback<>();
        worker.modifySourceConnectorOffsets(CONNECTOR_ID, sourceConnector, connectorProps, partitionOffsets, offsetStore, producer, offsetWriter, Thread.currentThread().getContextClassLoader(), cb);
    ...
    public void testNormalizeSourceConnectorOffsets() throws Exception {
        Map<Map<String, ?>, Map<String, ?>> offsets = Collections.singletonMap(Collections.singletonMap("filename", "/path/to/filename"), Collections.singletonMap("position", 20));
    ...
    public void testAlterOffsetsSinkConnectorNoDeletes() throws Exception {
        @SuppressWarnings("unchecked") ArgumentCaptor<Map<TopicPartition, OffsetAndMetadata>> alterOffsetsMapCapture = ArgumentCaptor.forClass(Map.class);
        Map<Map<String, ?>, Map<String, ?>> partitionOffsets = new HashMap<>();
    ...
    public void testAlterOffsetSinkConnectorOnlyDeletes() throws Exception {
        @SuppressWarnings("unchecked") ArgumentCaptor<Set<TopicPartition>> deleteOffsetsSetCapture = ArgumentCaptor.forClass(Set.class);
        Map<Map<String, ?>, Map<String, ?>> partitionOffsets = new HashMap<>();
        Map<String, String> partition1 = new HashMap<>();
        partition1.put(SinkUtils.KAFKA_TOPIC_KEY, "test_topic");
        partition1.put(SinkUtils.KAFKA_PARTITION_KEY, "10");
    ...
    private void alterOffsetsSinkConnector(Map<Map<String, ?>, Map<String, ?>> partitionOffsets, ArgumentCaptor<Map<TopicPartition, OffsetAndMetadata>> alterOffsetsMapCapture, ArgumentCaptor<Set<TopicPartition>> deleteOffsetsSetCapture) throws Exception {
        mockKafkaClusterId();
        String connectorClass = SampleSinkConnector.class.getName();
        connectorProps.put(CONNECTOR_CLASS_CONFIG, connectorClass);

        Admin admin = mock(Admin.class);
        worker = new Worker(WORKER_ID, new MockTime(), plugins, config, offsetBackingStore, Executors.newCachedThreadPool(), allConnectorClientConfigOverridePolicy, config -> admin);
        worker.start();
        ...
        if (alterOffsetsMapCapture != null) {
            ...
            when(admin.alterConsumerGroupOffsets(anyString(), alterOffsetsMapCapture.capture(), any(AlterConsumerGroupOffsetsOptions.class))).thenReturn(alterConsumerGroupOffsetsResult);
        ...
        if (deleteOffsetsSetCapture != null) {
            ...
            when(admin.deleteConsumerGroupOffsets(anyString(), deleteOffsetsSetCapture.capture(), any(DeleteConsumerGroupOffsetsOptions.class))).thenReturn(deleteConsumerGroupOffsetsResult);
        ...
        FutureCallback<Message> cb = new FutureCallback<>();
        worker.modifySinkConnectorOffsets(CONNECTOR_ID, sinkConnector, connectorProps, partitionOffsets, Thread.currentThread().getContextClassLoader(), cb);
        assertEquals("The offsets for this connector have been altered successfully", cb.get(1000, TimeUnit.MILLISECONDS).message());
    ...
    public void testAlterOffsetsSinkConnectorAlterOffsetsError() throws Exception {
        ...
        Admin admin = mock(Admin.class);
        worker = new Worker(WORKER_ID, new MockTime(), plugins, config, offsetBackingStore, Executors.newSingleThreadExecutor(), allConnectorClientConfigOverridePolicy, config -> admin);
        worker.start();
        ...
        AlterConsumerGroupOffsetsResult alterConsumerGroupOffsetsResult = mock(AlterConsumerGroupOffsetsResult.class);
        when(admin.alterConsumerGroupOffsets(anyString(), anyMap(), any(AlterConsumerGroupOffsetsOptions.class))).thenReturn(alterConsumerGroupOffsetsResult);
        ...
        partition1.put(SinkUtils.KAFKA_TOPIC_KEY, "test_topic");
        partition1.put(SinkUtils.KAFKA_PARTITION_KEY, "10");
        Map<Map<String, ?>, Map<String, ?>> partitionOffsets = Collections.singletonMap(partition1, Collections.singletonMap(SinkUtils.KAFKA_OFFSET_KEY, "100"));
    ...
    public void testAlterOffsetsSinkConnectorDeleteOffsetsError() throws Exception {
        ...
        DeleteConsumerGroupOffsetsResult deleteConsumerGroupOffsetsResult = mock(DeleteConsumerGroupOffsetsResult.class);
        when(admin.deleteConsumerGroupOffsets(anyString(), anySet(), any(DeleteConsumerGroupOffsetsOptions.class))).thenReturn(deleteConsumerGroupOffsetsResult);
    ...
    public void testAlterOffsetsSinkConnectorSynchronousError() throws Exception {
        ...
        when(admin.alterConsumerGroupOffsets(anyString(), anyMap(), any(AlterConsumerGroupOffsetsOptions.class))).thenThrow(new RuntimeException("Test Exception"));
    ...
    public void testResetOffsetsSourceConnectorExactlyOnceSupportEnabled() throws Exception {
        ...
        FutureCallback<Message> cb = new FutureCallback<>();
        worker.modifySourceConnectorOffsets(CONNECTOR_ID, sourceConnector, connectorProps, null, offsetStore, producer, offsetWriter, Thread.currentThread().getContextClassLoader(), cb);
    ...
    public void testResetOffsetsSinkConnector() throws Exception {
        ...
        worker = new Worker(WORKER_ID, time, plugins, config, offsetBackingStore, Executors.newCachedThreadPool(), allConnectorClientConfigOverridePolicy, config -> admin);
        worker.start();
        ...
        FutureCallback<Message> cb = new FutureCallback<>();
        worker.modifySinkConnectorOffsets(CONNECTOR_ID, sinkConnector, connectorProps, null, Thread.currentThread().getContextClassLoader(), cb);
        assertEquals("The offsets for this connector have been reset successfully", cb.get(1000, TimeUnit.MILLISECONDS).message());
        ...
        assertEquals((int) ConnectResource.DEFAULT_REST_REQUEST_TIMEOUT_MS - 2000L - 3000L, deleteConsumerGroupsOptionsArgumentCaptor.getValue().timeoutMs().intValue());
        verify(admin, timeout(1000)).close();
        verifyKafkaClusterId();
    }
    ...
    public void testModifySourceConnectorOffsetsTimeout() throws Exception {
        ...
        Time time = new MockTime();
        mockInternalConverters();
        worker = new Worker(WORKER_ID, time, plugins, config, offsetBackingStore, Executors.newSingleThreadExecutor(), allConnectorClientConfigOverridePolicy, null);
        worker.start();
        ...
        Map<Map<String, ?>, Map<String, ?>> partitionOffsets = Collections.singletonMap(Collections.singletonMap("partitionKey", "partitionValue"), Collections.singletonMap("offsetKey", "offsetValue"));
    ...
    public void testModifyOffsetsSinkConnectorTimeout() throws Exception {
        ...
        FutureCallback<Message> cb = new FutureCallback<>();
        worker.modifySinkConnectorOffsets(CONNECTOR_ID, sinkConnector, connectorProps, new HashMap<>(), Thread.currentThread().getContextClassLoader(), cb);
        ExecutionException e = assertThrows(ExecutionException.class, () -> cb.get(1000, TimeUnit.MILLISECONDS).message());
        assertEquals(ConnectException.class, e.getCause().getClass());
        assertThat(e.getCause().getMessage(), containsString("Timed out"));
    ...
    private void mockInternalConverters() {
        ...
        when(plugins.newInternalConverter(eq(true), anyString(), anyMap())).thenReturn(jsonConverter);

        when(plugins.newInternalConverter(eq(false), anyString(), anyMap())).thenReturn(jsonConverter);
    }
    ...
    private void mockTaskConverter(ClassLoaderUsage classLoaderUsage, String converterClassConfig, Converter returning) {
        when(plugins.newConverter(any(AbstractConfig.class), eq(converterClassConfig), eq(classLoaderUsage))).thenReturn(returning);
    }
    ...
    private void mockTaskHeaderConverter(ClassLoaderUsage classLoaderUsage, HeaderConverter returning) {
        when(plugins.newHeaderConverter(any(AbstractConfig.class), eq(WorkerConfig.HEADER_CONVERTER_CLASS_CONFIG), eq(classLoaderUsage))).thenReturn(returning);
    }
