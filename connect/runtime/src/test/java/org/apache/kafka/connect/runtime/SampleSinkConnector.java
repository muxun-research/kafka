...
public class SampleSinkConnector extends SinkConnector {
    ...
    public ConfigDef configWithCommon() {
        return new ConfigDef(SinkConnectorConfig.configDef()).define("required", ConfigDef.Type.STRING, ConfigDef.Importance.HIGH, "required docs").define("optional", ConfigDef.Type.STRING, "defaultVal", ConfigDef.Importance.HIGH, "optional docs");
    }
}
