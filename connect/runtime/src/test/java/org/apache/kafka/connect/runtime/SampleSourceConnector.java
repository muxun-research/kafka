...
public class SampleSourceConnector extends SourceConnector {
    ...
    public ConfigDef configWithCommon() {
        return new ConfigDef(SourceConnectorConfig.configDef()).define("required", ConfigDef.Type.STRING, ConfigDef.Importance.HIGH, "required docs").define("optional", ConfigDef.Type.STRING, "defaultVal", ConfigDef.Importance.HIGH, "optional docs");
    }
