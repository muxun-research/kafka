...
public class ConnectorConfigTest<R extends ConnectRecord<R>> {
    ...
    public void abstractTransform() {
        ...
        try {
            ...
            assertTrue(ex.getMessage().contains("Transformation is abstract and cannot be created."));
        }
    }
    ...
    public void abstractKeyValueTransform() {
        ...
        try {
            ...
            assertTrue(ex.getMessage().contains("Transformation is abstract and cannot be created."));
            assertTrue(ex.getMessage().contains(AbstractKeyValueTransformation.Key.class.getName()));
            assertTrue(ex.getMessage().contains(AbstractKeyValueTransformation.Value.class.getName()));
        }
    }
