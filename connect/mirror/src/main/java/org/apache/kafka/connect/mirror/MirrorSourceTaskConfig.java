...
public class MirrorSourceTaskConfig extends MirrorSourceConfig {
    ...
    protected static final ConfigDef TASK_CONFIG_DEF = new ConfigDef(CONNECTOR_CONFIG_DEF).define(TASK_TOPIC_PARTITIONS, ConfigDef.Type.LIST, null, ConfigDef.Importance.LOW, TASK_TOPIC_PARTITIONS_DOC).define(TASK_INDEX, ConfigDef.Type.INT, null, ConfigDef.Importance.LOW, "The index of the task");
}
