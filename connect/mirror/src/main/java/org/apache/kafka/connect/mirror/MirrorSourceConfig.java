...
public class MirrorSourceConfig extends MirrorConnectorConfig {
    ...
    public MirrorSourceConfig(Map<String, String> props) {
        super(CONNECTOR_CONFIG_DEF, ConfigUtils.translateDeprecatedConfigs(props, new String[][]{{TOPICS_EXCLUDE, TOPICS_EXCLUDE_ALIAS}, {CONFIG_PROPERTIES_EXCLUDE, CONFIG_PROPERTIES_EXCLUDE_ALIAS}}));
    }
    ...
    String offsetSyncsTopic() {
        String otherClusterAlias = SOURCE_CLUSTER_ALIAS_DEFAULT.equals(offsetSyncsTopicLocation()) ? targetClusterAlias() : sourceClusterAlias();
    ...
    Map<String, Object> offsetSyncsTopicAdminConfig() {
        return SOURCE_CLUSTER_ALIAS_DEFAULT.equals(offsetSyncsTopicLocation()) ? sourceAdminConfig(OFFSET_SYNCS_SOURCE_ADMIN_ROLE) : targetAdminConfig(OFFSET_SYNCS_TARGET_ADMIN_ROLE);
    }

    Map<String, Object> offsetSyncsTopicProducerConfig() {
        return SOURCE_CLUSTER_ALIAS_DEFAULT.equals(offsetSyncsTopicLocation()) ? sourceProducerConfig(OFFSET_SYNCS_SOURCE_PRODUCER_ROLE) : targetProducerConfig(OFFSET_SYNCS_TARGET_PRODUCER_ROLE);
    }
