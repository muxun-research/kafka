...
public class MirrorHeartbeatConfig extends MirrorConnectorConfig {
    ...
    protected static final ConfigDef CONNECTOR_CONFIG_DEF = new ConfigDef(BASE_CONNECTOR_CONFIG_DEF).define(EMIT_HEARTBEATS_ENABLED, ConfigDef.Type.BOOLEAN, EMIT_HEARTBEATS_ENABLED_DEFAULT, ConfigDef.Importance.LOW, EMIT_HEARTBEATS_ENABLED_DOC).define(EMIT_HEARTBEATS_INTERVAL_SECONDS, ConfigDef.Type.LONG, EMIT_HEARTBEATS_INTERVAL_SECONDS_DEFAULT, ConfigDef.Importance.LOW, EMIT_HEARTBEATS_INTERVAL_SECONDS_DOC).define(HEARTBEATS_TOPIC_REPLICATION_FACTOR, ConfigDef.Type.SHORT, HEARTBEATS_TOPIC_REPLICATION_FACTOR_DEFAULT, ConfigDef.Importance.LOW, HEARTBEATS_TOPIC_REPLICATION_FACTOR_DOC);
