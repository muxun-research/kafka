...
public class MirrorCheckpointConfig extends MirrorConnectorConfig {
    ...
    public MirrorCheckpointConfig(Map<String, String> props) {
        super(CONNECTOR_CONFIG_DEF, ConfigUtils.translateDeprecatedConfigs(props, new String[][]{{GROUPS_EXCLUDE, GROUPS_EXCLUDE_ALIAS},}));
    }
    ...
    Map<String, Object> offsetSyncsTopicConsumerConfig() {
        return SOURCE_CLUSTER_ALIAS_DEFAULT.equals(offsetSyncsTopicLocation()) ? sourceConsumerConfig(OFFSET_SYNCS_SOURCE_CONSUMER_ROLE) : targetConsumerConfig(OFFSET_SYNCS_TARGET_CONSUMER_ROLE);
    }
