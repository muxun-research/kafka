...
public class ConnectorClientConfigRequest {
    ...
    public ConnectorClientConfigRequest(String connectorName, ConnectorType connectorType, Class<? extends Connector> connectorClass, Map<String, Object> clientProps, ClientType clientType) {
