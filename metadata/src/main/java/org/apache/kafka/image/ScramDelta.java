...
public final class ScramDelta {
    ...
    public void finishSnapshot() {
        for (Entry<ScramMechanism, Map<String, ScramCredentialData>> mechanismEntry : image.mechanisms().entrySet()) {
            Map<String, Optional<ScramCredentialData>> userNameMap = changes.computeIfAbsent(mechanismEntry.getKey(), __ -> new HashMap<>());
    ...
    public void replay(UserScramCredentialRecord record) {
        ...
        Map<String, Optional<ScramCredentialData>> userChanges = changes.computeIfAbsent(mechanism, __ -> new HashMap<>());
    ...
    public ScramImage apply() {
        ...
        for (Entry<ScramMechanism, Map<String, Optional<ScramCredentialData>>> mechanismChangeEntry : changes.entrySet()) {
            Map<String, ScramCredentialData> userMap = newMechanisms.computeIfAbsent(mechanismChangeEntry.getKey(), __ -> new HashMap<>());
    ...
    public String toString() {
        return "ScramDelta(" + "changes=" + changes + ')';
    }
}
