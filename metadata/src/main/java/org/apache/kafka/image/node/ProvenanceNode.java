...
public class ProvenanceNode implements MetadataNode {
    ...
    public void print(MetadataNodePrinter printer) {
        ...
        printer.output("offset " + provenance.lastContainedOffset() + ", epoch " + provenance.lastContainedEpoch() + ", time " + DateTimeFormatter.ISO_ZONED_DATE_TIME.format(zonedDateTime));
    }
}
