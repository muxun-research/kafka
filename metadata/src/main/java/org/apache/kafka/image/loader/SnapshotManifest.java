...
public class SnapshotManifest implements LoaderManifest {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(provenance, elapsedNs);
    }
    ...
    public boolean equals(Object o) {
        ...
        return provenance.equals(other.provenance) && elapsedNs == other.elapsedNs;
    }

    @Override
    public String toString() {
        return "SnapshotManifest(" + "provenance=" + provenance + ", elapsedNs=" + elapsedNs + ")";
    }
}
