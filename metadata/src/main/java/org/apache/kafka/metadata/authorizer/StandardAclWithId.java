...
final public class StandardAclWithId {
    ...
    public AccessControlEntryRecord toRecord() {
        return new AccessControlEntryRecord().setId(id).setResourceType(acl.resourceType().code()).setResourceName(acl.resourceName()).setPatternType(acl.patternType().code()).setPrincipal(acl.principal()).setHost(acl.host()).setOperation(acl.operation().code()).setPermissionType(acl.permissionType().code());
    }
    ...
    public boolean equals(Object o) {
        ...
        return id.equals(other.id) && acl.equals(other.acl);
    }
    ...
    public String toString() {
        return "StandardAclWithId(" + "id=" + id + ", acl=" + acl + ")";
    }
}
