...
public class MigrationManifest {
    ...
    MigrationManifest(int totalRecords, int totalBatches, long durationNanos, Map<MetadataRecordType, Integer> recordTypeCounts) {
    ...
    public boolean equals(Object o) {
        ...
        return totalRecords == that.totalRecords && totalBatches == that.totalBatches && durationNanos == that.durationNanos && recordTypeCounts.equals(that.recordTypeCounts);
    }
    ...
    public String toString() {
        return String.format("%d records were generated in %d ms across %d batches. The record types were %s", totalRecords, durationMs(), totalBatches, recordTypeCounts);
    }
}