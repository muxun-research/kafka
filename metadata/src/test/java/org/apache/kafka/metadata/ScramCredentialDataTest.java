...
public class ScramCredentialDataTest {
    ...
    public void testToString() {
        assertEquals("ScramCredentialData" + "(salt=" + "[hidden]" + ", storedKey=" + "[hidden]" + ", serverKey=" + "[hidden]" + ", iterations=" + "[hidden]" + ")", SCRAMCREDENTIALDATA.get(0).toString());
    }
    ...
    private void testRoundTrip(ScramCredentialData scramCredentialData) {
        ApiMessageAndVersion messageAndVersion = new ApiMessageAndVersion(scramCredentialData.toRecord("alice", ScramMechanism.SCRAM_SHA_256), (short) 0);
        ScramCredentialData scramCredentialData2 = ScramCredentialData.fromRecord((UserScramCredentialRecord) messageAndVersion.message());
        assertEquals(scramCredentialData, scramCredentialData2);
        ApiMessageAndVersion messageAndVersion2 = new ApiMessageAndVersion(scramCredentialData2.toRecord("alice", ScramMechanism.SCRAM_SHA_256), (short) 0);
