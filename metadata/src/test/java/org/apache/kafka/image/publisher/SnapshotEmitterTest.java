...
public class SnapshotEmitterTest {
    ...
    public void testEmit() throws Exception {
        ...
        SnapshotEmitter emitter = new SnapshotEmitter.Builder().setBatchSize(2).setRaftClient(mockRaftClient).build();
        ...
        assertEquals(MetadataImageTest.IMAGE1.highestOffsetAndEpoch().offset(), writer.lastContainedLogOffset());
        assertEquals(MetadataImageTest.IMAGE1.highestOffsetAndEpoch().epoch(), writer.lastContainedLogEpoch());
