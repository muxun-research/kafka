...
public class ScramCredentialDataNodeTest {
    ...
    public void testPrintRedacted() {
        ...
        assertEquals("ScramCredentialData(" + "salt=[redacted], " + "storedKey=[redacted], " + "serverKey=[redacted], " + "iterations=[redacted])", stringifier.toString());
    }
    ...
    public void testPrintUnredacted() {
        ...
        new ScramCredentialDataNode(DATA).print(stringifier);
        assertEquals("ScramCredentialData(" + "salt=4f1d6ea31e58c5ad3aaeb3266f55cce6, " + "storedKey=3cfa1c3421b512d1d1dfc3355138b4ad, " + "serverKey=2d9781209073e8d03aee3cbc63a1d4ca, " + "iterations=16)", stringifier.toString());
    }
}
