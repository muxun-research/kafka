...
import static org.apache.kafka.controller.errors.ControllerExceptions.*;
...
public class ControllerExceptionsTest {
    ...
    public void testWrappedTimeoutExceptionIsTimeoutException() {
        assertTrue(isTimeoutException(new ExecutionException("execution exception", new TimeoutException())));
    }
    ...
    public void testNewPreMigrationExceptionWithNoController() {
        assertExceptionsMatch(new NotControllerException("No controller appears to be active."), newPreMigrationException(OptionalInt.empty()));
    }

    @Test
    public void testNewPreMigrationExceptionWithActiveController() {
        assertExceptionsMatch(new NotControllerException("The controller is in pre-migration mode."), newPreMigrationException(OptionalInt.of(1)));
    }

    @Test
    public void testNewWrongControllerExceptionWithNoController() {
        assertExceptionsMatch(new NotControllerException("No controller appears to be active."), newWrongControllerException(OptionalInt.empty()));
    }

    @Test
    public void testNewWrongControllerExceptionWithActiveController() {
        assertExceptionsMatch(new NotControllerException("The active controller appears to be node 1."), newWrongControllerException(OptionalInt.of(1)));
    }
    ...
    public void testApiExceptionToExternalException() {
        assertExceptionsMatch(new TopicExistsException("Topic foo exists"), toExternalException(new TopicExistsException("Topic foo exists"), () -> OptionalInt.of(1)));
    }

    @Test
    public void testNotLeaderExceptionToExternalException() {
        assertExceptionsMatch(new NotControllerException("The active controller appears to be node 1."), toExternalException(new NotLeaderException("Append failed because the given epoch 123 is stale."), () -> OptionalInt.of(1)));
    }

    @Test
    public void testRejectedExecutionExceptionToExternalException() {
        assertExceptionsMatch(new TimeoutException("The controller is shutting down.", new RejectedExecutionException("The event queue is shutting down")), toExternalException(new RejectedExecutionException("The event queue is shutting down"), () -> OptionalInt.empty()));
    }

    @Test
    public void testInterruptedExceptionToExternalException() {
        assertExceptionsMatch(new UnknownServerException("The controller was interrupted."), toExternalException(new InterruptedException(), () -> OptionalInt.empty()));
    }

    @Test
    public void testRuntimeExceptionToExternalException() {
        assertExceptionsMatch(new UnknownServerException(new NullPointerException("Null pointer exception")), toExternalException(new NullPointerException("Null pointer exception"), () -> OptionalInt.empty()));
    }
}
