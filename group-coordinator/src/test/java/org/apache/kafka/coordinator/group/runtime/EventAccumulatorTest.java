...
public class EventAccumulatorTest {
    ...
    public void testDoneUnblockWaitingThreads() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        assertEquals(event0, CompletableFuture.anyOf(futures.toArray(new CompletableFuture[0])).get(5, TimeUnit.SECONDS));
        ...
        assertEquals(event1, CompletableFuture.anyOf(futures.toArray(new CompletableFuture[0])).get(5, TimeUnit.SECONDS));
        ...
        assertEquals(event2, CompletableFuture.anyOf(futures.toArray(new CompletableFuture[0])).get(5, TimeUnit.SECONDS));
