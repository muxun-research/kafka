...
public class ReplicatedGroupCoordinatorTest {
    ...
    public void testConsumerGroupHeartbeat() {
        ...
        ReplicatedGroupCoordinator coordinator = new ReplicatedGroupCoordinator(groupMetadataManager);
        ...
        CoordinatorResult<ConsumerGroupHeartbeatResponseData, Record> result = new CoordinatorResult<>(Collections.emptyList(), new ConsumerGroupHeartbeatResponseData());

        when(coordinator.consumerGroupHeartbeat(context, request)).thenReturn(result);
    ...
    public void testReplayConsumerGroupMetadata() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 3), new ApiMessageAndVersion(value, (short) 0)));
    ...
    public void testReplayConsumerGroupMetadataWithNullValue() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 3), null));
    ...
    public void testReplayConsumerGroupPartitionMetadata() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 4), new ApiMessageAndVersion(value, (short) 0)));
    ...
    public void testReplayConsumerGroupPartitionMetadataWithNullValue() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 4), null));
    ...
    public void testReplayConsumerGroupMemberMetadata() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 5), new ApiMessageAndVersion(value, (short) 0)));
    ...
    public void testReplayConsumerGroupMemberMetadataWithNullValue() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 5), null));
    ...
    public void testReplayConsumerGroupTargetAssignmentMetadata() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 6), new ApiMessageAndVersion(value, (short) 0)));
    ...
    public void testReplayConsumerGroupTargetAssignmentMetadataWithNullValue() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 6), null));
    ...
    public void testReplayConsumerGroupTargetAssignmentMember() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 7), new ApiMessageAndVersion(value, (short) 0)));
    ...
    public void testReplayConsumerGroupTargetAssignmentMemberKeyWithNullValue() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 7), null));
    ...
    public void testReplayConsumerGroupCurrentMemberAssignment() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 8), new ApiMessageAndVersion(value, (short) 0)));
    ...
    public void testReplayConsumerGroupCurrentMemberAssignmentWithNullValue() {
        ...
        coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 8), null));
    ...
    public void testReplayWithUnsupportedVersion() {
        ...
        assertThrows(IllegalStateException.class, () -> coordinator.replay(new Record(new ApiMessageAndVersion(key, (short) 255), new ApiMessageAndVersion(value, (short) 0))));
    }
    ...
    public void testOnLoaded() {
        ...
        verify(groupMetadataManager, times(1)).onNewMetadataImage(eq(image), any());
