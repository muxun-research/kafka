...
public class GenericGroupMemberTest {
    ...
    public void testMatchesSupportedProtocols() {
        GenericGroupMember member = new GenericGroupMember("member", Optional.of("group-instance-id"), "client-id", "client-host", 10, 4500, "generic", Collections.singletonList(new Protocol("range", new byte[]{0})), EMPTY_METADATA);

        assertTrue(member.matches(Collections.singletonList(new Protocol("range", new byte[]{0}))));
        assertFalse(member.matches(Collections.singletonList(new Protocol("range", new byte[]{1}))));
        assertFalse(member.matches(Collections.singletonList(new Protocol("roundrobin", EMPTY_METADATA))));
    ...
    public void testVoteForPreferredProtocol() {
        ...
        GenericGroupMember member = new GenericGroupMember("member", Optional.of("group-instance-id"), "client-id", "client-host", 10, 4500, "generic", protocols, EMPTY_ASSIGNMENT);
    ...
    public void testMetadataRaisesOnUnsupportedProtocol() {
        ...
        assertThrows(IllegalArgumentException.class, () -> member.metadata("unknown"));
    }
    ...
    public void testVoteRaisesOnNoSupportedProtocols() {
        ...
        assertThrows(IllegalArgumentException.class, () -> member.vote(Collections.singleton("unknown")));
    }
    ...
    public void testHasHeartbeatSatisfied() {
        GenericGroupMember member = new GenericGroupMember("member", Optional.of("group-instance-id"), "client-id", "client-host", 10, 4500, "generic", Collections.singletonList(new Protocol("range", EMPTY_METADATA)), EMPTY_ASSIGNMENT);
