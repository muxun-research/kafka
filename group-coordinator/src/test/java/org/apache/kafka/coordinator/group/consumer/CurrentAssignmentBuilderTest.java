...
public class CurrentAssignmentBuilderTest {
    ...
    public void testTransitionFromNewTargetToRevoke() {
        ...
        ConsumerGroupMember member = new ConsumerGroupMember.Builder("member").setMemberEpoch(10).setPreviousMemberEpoch(10).setTargetMemberEpoch(10).setAssignedPartitions(mkAssignment(mkTopicAssignment(topicId1, 1, 2, 3), mkTopicAssignment(topicId2, 4, 5, 6))).build();

        assertEquals(ConsumerGroupMember.MemberState.STABLE, member.state());

        Assignment targetAssignment = new Assignment(mkAssignment(mkTopicAssignment(topicId1, 3, 4, 5), mkTopicAssignment(topicId2, 6, 7, 8)));
        ...
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 3), mkTopicAssignment(topicId2, 6)), updatedMember.assignedPartitions());
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 1, 2), mkTopicAssignment(topicId2, 4, 5)), updatedMember.partitionsPendingRevocation());
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 4, 5), mkTopicAssignment(topicId2, 7, 8)), updatedMember.partitionsPendingAssignment());
    }
    ...
    public void testTransitionFromNewTargetToAssigning() {
        ...
        Assignment targetAssignment = new Assignment(mkAssignment(mkTopicAssignment(topicId1, 1, 2, 3, 4, 5), mkTopicAssignment(topicId2, 4, 5, 6, 7, 8)));
        ...
        assertEquals(11, updatedMember.targetMemberEpoch());
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 1, 2, 3), mkTopicAssignment(topicId2, 4, 5, 6)), updatedMember.assignedPartitions());
    ...
    public void testTransitionFromNewTargetToStable() {
        ...
        Assignment targetAssignment = new Assignment(mkAssignment(mkTopicAssignment(topicId1, 1, 2, 3), mkTopicAssignment(topicId2, 4, 5, 6)));
    ...
    private static Stream<Arguments> ownedTopicPartitionsArguments() {
        return Stream.of(
                ...
                Collections.emptyList()).map(Arguments::of);
    }
    ...
    public void testTransitionFromRevokeToAssigning() {
        ...
        ConsumerGroupMember updatedMember = new CurrentAssignmentBuilder(member).withTargetAssignment(11, targetAssignment).withCurrentPartitionEpoch((topicId, partitionId) -> 10).withOwnedTopicPartitions(requestFromAssignment(mkAssignment(mkTopicAssignment(topicId1, 3), mkTopicAssignment(topicId2, 6)))).build();
    ...
    public void testTransitionFromRevokeToStable() {
        ...
        ConsumerGroupMember updatedMember = new CurrentAssignmentBuilder(member).withTargetAssignment(11, targetAssignment).withCurrentPartitionEpoch((topicId, partitionId) -> -1).withOwnedTopicPartitions(requestFromAssignment(mkAssignment(mkTopicAssignment(topicId1, 3), mkTopicAssignment(topicId2, 6)))).build();

        assertEquals(ConsumerGroupMember.MemberState.STABLE, updatedMember.state());
        assertEquals(10, updatedMember.previousMemberEpoch());
        assertEquals(11, updatedMember.memberEpoch());
        assertEquals(11, updatedMember.targetMemberEpoch());
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 3, 4, 5), mkTopicAssignment(topicId2, 6, 7, 8)), updatedMember.assignedPartitions());
        assertEquals(Collections.emptyMap(), updatedMember.partitionsPendingRevocation());
        assertEquals(Collections.emptyMap(), updatedMember.partitionsPendingAssignment());
    }
    ...
    public void testTransitionFromAssigningToAssigning() {
        ...
        ConsumerGroupMember member = new ConsumerGroupMember.Builder("member").setMemberEpoch(10).setPreviousMemberEpoch(11).setTargetMemberEpoch(11).setAssignedPartitions(mkAssignment(mkTopicAssignment(topicId1, 3), mkTopicAssignment(topicId2, 6))).setPartitionsPendingAssignment(mkAssignment(mkTopicAssignment(topicId1, 4, 5), mkTopicAssignment(topicId2, 7, 8))).build();
        ...
        assertEquals(11, updatedMember.memberEpoch());
        assertEquals(11, updatedMember.targetMemberEpoch());
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 3, 4, 5), mkTopicAssignment(topicId2, 6)), updatedMember.assignedPartitions());
        assertEquals(Collections.emptyMap(), updatedMember.partitionsPendingRevocation());
        assertEquals(mkAssignment(mkTopicAssignment(topicId2, 7, 8)), updatedMember.partitionsPendingAssignment());
    }
    ...
    public void testTransitionFromStableToStable() {
        ...
        ConsumerGroupMember member = new ConsumerGroupMember.Builder("member").setMemberEpoch(11).setPreviousMemberEpoch(11).setTargetMemberEpoch(11).setAssignedPartitions(mkAssignment(mkTopicAssignment(topicId1, 3, 4, 5), mkTopicAssignment(topicId2, 6, 7, 8))).build();
    ...
    public void testNewTargetRestartReconciliation() {
        ...
        Assignment targetAssignment = new Assignment(mkAssignment(mkTopicAssignment(topicId1, 6, 7, 8), mkTopicAssignment(topicId2, 9, 10, 11)));
        ...
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 1, 2, 3), mkTopicAssignment(topicId2, 4, 5, 6)), updatedMember.partitionsPendingRevocation());
        assertEquals(mkAssignment(mkTopicAssignment(topicId1, 6, 7, 8), mkTopicAssignment(topicId2, 9, 10, 11)), updatedMember.partitionsPendingAssignment());
    }
