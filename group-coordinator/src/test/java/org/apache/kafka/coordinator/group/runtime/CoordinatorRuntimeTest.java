...
public class CoordinatorRuntimeTest {
    ...
    private static class MockPartitionWriter extends InMemoryPartitionWriter<String> {
        ...
        public long append(TopicPartition tp, List<String> records) throws KafkaException {
            if (records.size() <= maxRecordsInBatch) {
                ...
                throw new KafkaException(String.format("Number of records %d greater than the maximum allowed %d.", records.size(), maxRecordsInBatch));
            }
        }
    }
    ...
    private static class MockCoordinator implements Coordinator<String> {
        ...
        MockCoordinator(SnapshotRegistry snapshotRegistry, CoordinatorTimer<String> timer) {
    ...
    private static class MockCoordinatorBuilder implements CoordinatorBuilder<MockCoordinator, String> {
        ...
        @Override
        public CoordinatorBuilder<MockCoordinator, String> withSnapshotRegistry(SnapshotRegistry snapshotRegistry) {
            this.snapshotRegistry = snapshotRegistry;
            return this;
        }

        @Override
        public CoordinatorBuilder<MockCoordinator, String> withLogContext(LogContext logContext) {
            return this;
        }

        @Override
        public CoordinatorBuilder<MockCoordinator, String> withTime(Time time) {
            return this;
        }

        @Override
        public CoordinatorBuilder<MockCoordinator, String> withTimer(CoordinatorTimer<String> timer) {
            this.timer = timer;
            return this;
        }
        ...
        public MockCoordinator build() {
            return new MockCoordinator(Objects.requireNonNull(this.snapshotRegistry), Objects.requireNonNull(this.timer));
        }
    }
    ...
    public void testScheduleLoading() {
        ...
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(loader).withEventProcessor(new DirectEventProcessor()).withPartitionWriter(writer).withCoordinatorBuilderSupplier(supplier).build();
        ...
        verify(writer, times(1)).registerListener(eq(TP), any(PartitionWriter.Listener.class));
    ...
    public void testScheduleLoadingWithFailure() {
        ...
        verify(writer, times(1)).deregisterListener(eq(TP), any(PartitionWriter.Listener.class));
    }
    ...
    public void testScheduleLoadingWithStalePartitionEpoch() {
        ...
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(loader).withEventProcessor(new DirectEventProcessor()).withPartitionWriter(new MockPartitionWriter()).withCoordinatorBuilderSupplier(supplier).build();
    ...
    public void testScheduleUnloading() {
        ...
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(new MockCoordinatorLoader()).withEventProcessor(new DirectEventProcessor()).withPartitionWriter(writer).withCoordinatorBuilderSupplier(supplier).build();
    ...
    public void testScheduleUnloadingWithStalePartitionEpoch() {
        ...
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(new MockCoordinatorLoader()).withEventProcessor(new DirectEventProcessor()).withPartitionWriter(new MockPartitionWriter()).withCoordinatorBuilderSupplier(supplier).build();
    ...
    public void testScheduleWriteOp() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(new MockCoordinatorLoader()).withEventProcessor(new DirectEventProcessor()).withPartitionWriter(writer).withCoordinatorBuilderSupplier(new MockCoordinatorBuilderSupplier()).build();
        ...
        // Write #1.
        CompletableFuture<String> write1 = runtime.scheduleWriteOperation("write#1", TP, state -> new CoordinatorResult<>(Arrays.asList("record1", "record2"), "response1"));
        ...
        // Write #2.
        CompletableFuture<String> write2 = runtime.scheduleWriteOperation("write#2", TP, state -> new CoordinatorResult<>(Arrays.asList("record3"), "response2"));
        ...
        CompletableFuture<String> write3 = runtime.scheduleWriteOperation("write#3", TP, state -> new CoordinatorResult<>(Collections.emptyList(), "response3"));
        ...
        CompletableFuture<String> write4 = runtime.scheduleWriteOperation("write#4", TP, state -> new CoordinatorResult<>(Collections.emptyList(), "response4"));
    ...
    public void testScheduleWriteOpWhenInactive() {
        MockTimer timer = new MockTimer();
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(new MockCoordinatorLoader()).withEventProcessor(new DirectEventProcessor()).withPartitionWriter(new MockPartitionWriter()).withCoordinatorBuilderSupplier(new MockCoordinatorBuilderSupplier()).build();

        // Scheduling a write fails with a NotCoordinatorException because the coordinator
        // does not exist.
        CompletableFuture<String> write = runtime.scheduleWriteOperation("write", TP, state -> new CoordinatorResult<>(Collections.emptyList(), "response1"));
    ...
    public void testScheduleWriteOpWhenReplayFails() {
        ...
        CompletableFuture<String> write = runtime.scheduleWriteOperation("write", TP, state -> new CoordinatorResult<>(Arrays.asList("record1", "record2"), "response1"));
    ...
    public void testScheduleWriteOpWhenWriteFails() {
        ...
        runtime.scheduleWriteOperation("write#1", TP, state -> new CoordinatorResult<>(Arrays.asList("record1", "record2"), "response1"));
        ...
        CompletableFuture<String> write2 = runtime.scheduleWriteOperation("write#2", TP, state -> new CoordinatorResult<>(Arrays.asList("record3", "record4", "record5"), "response2"));
    ...
    public void testScheduleReadOp() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        // Write #2.
        CompletableFuture<String> write2 = runtime.scheduleWriteOperation("write#2", TP, state -> new CoordinatorResult<>(Arrays.asList("record3", "record4"), "response2"));
    ...
    public void testScheduleReadOpWhenPartitionInactive() {
        ...
        CompletableFuture<String> read = runtime.scheduleReadOperation("read", TP, (state, offset) -> "read-response");
    ...
    public void testScheduleReadOpWhenOpsFails() {
        ...
        // Write #2.
        runtime.scheduleWriteOperation("write#2", TP, state -> new CoordinatorResult<>(Arrays.asList("record3", "record4"), "response2"));
    ...
    public void testClose() throws Exception {
        ...
        MockTimer timer = new MockTimer();
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(loader).withEventProcessor(new DirectEventProcessor()).withPartitionWriter(new MockPartitionWriter()).withCoordinatorBuilderSupplier(new MockCoordinatorBuilderSupplier()).build();
        ...
        ctx.coordinator.timer.schedule("timer-1", 10, TimeUnit.SECONDS, true, () -> Arrays.asList("record5", "record6"));
    ...
    public void testOnNewMetadataImage() {
        ...
        when(builder.withTime(any())).thenReturn(builder);
        when(builder.withTimer(any())).thenReturn(builder);
        when(builder.build()).thenReturn(coordinator0).thenReturn(coordinator1);
    ...
    public void testScheduleTimer() throws InterruptedException {
        ...
        // Timer #1.
        ctx.coordinator.timer.schedule("timer-1", 10, TimeUnit.MILLISECONDS, true, () -> Arrays.asList("record1", "record2"));

        // Timer #2.
        ctx.coordinator.timer.schedule("timer-2", 20, TimeUnit.MILLISECONDS, true, () -> Arrays.asList("record3", "record4"));
    ...
    public void testRescheduleTimer() throws InterruptedException {
        ...
        CoordinatorRuntime<MockCoordinator, String> runtime = new CoordinatorRuntime.Builder<MockCoordinator, String>().withTime(timer.time()).withTimer(timer).withLoader(new MockCoordinatorLoader()).withEventProcessor(processor).withPartitionWriter(new MockPartitionWriter()).withCoordinatorBuilderSupplier(new MockCoordinatorBuilderSupplier()).build();
        ...
        // Timer #1.
        ctx.coordinator.timer.schedule("timer-1", 10, TimeUnit.MILLISECONDS, true, () -> Collections.singletonList("record1"));
        ...
        ctx.coordinator.timer.schedule("timer-1", 10, TimeUnit.MILLISECONDS, true, () -> Collections.singletonList("record2"));

        // The coordinator timer should still have one pending task.
        assertEquals(1, ctx.timer.size());

        // Schedule a third timer with the same key.
        ctx.coordinator.timer.schedule("timer-1", 10, TimeUnit.MILLISECONDS, true, () -> Collections.singletonList("record3"));
