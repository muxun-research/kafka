...
public class TopicMetadataTest {
    ...
    public void testFromRecord() {
        ...
        ConsumerGroupPartitionMetadataValue.TopicMetadata record = new ConsumerGroupPartitionMetadataValue.TopicMetadata().setTopicId(topicId).setTopicName(topicName).setNumPartitions(15);

        assertEquals(new TopicMetadata(topicId, topicName, 15), TopicMetadata.fromRecord(record));
    }
}
