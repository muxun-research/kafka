...
public class ReplicatedGroupCoordinator implements Coordinator<Record> {
    ...
    public static class Builder implements CoordinatorBuilder<ReplicatedGroupCoordinator, Record> {
        ...
        @Override
        public CoordinatorBuilder<ReplicatedGroupCoordinator, Record> withLogContext(LogContext logContext) {
            this.logContext = logContext;
            return this;
        }

        @Override
        public CoordinatorBuilder<ReplicatedGroupCoordinator, Record> withTime(Time time) {
            this.time = time;
            return this;
        }

        @Override
        public CoordinatorBuilder<ReplicatedGroupCoordinator, Record> withTimer(CoordinatorTimer<Record> timer) {
            this.timer = timer;
            return this;
        }

        @Override
        public CoordinatorBuilder<ReplicatedGroupCoordinator, Record> withSnapshotRegistry(SnapshotRegistry snapshotRegistry) {
        ...
        public ReplicatedGroupCoordinator build() {
            ...
            return new ReplicatedGroupCoordinator(new GroupMetadataManager.Builder().withLogContext(logContext).withSnapshotRegistry(snapshotRegistry).withTime(time).withTimer(timer).withAssignors(config.consumerGroupAssignors).withConsumerGroupMaxSize(config.consumerGroupMaxSize).withConsumerGroupHeartbeatInterval(config.consumerGroupHeartbeatIntervalMs).build());
        }
    }
     ...
     */
    ReplicatedGroupCoordinator(GroupMetadataManager groupMetadataManager) {
