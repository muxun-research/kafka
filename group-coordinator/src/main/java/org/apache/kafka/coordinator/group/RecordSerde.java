...
public class RecordSerde implements PartitionWriter.Serializer<Record>, CoordinatorLoader.Deserializer<Record> {
    ...
    @Override
    public Record deserialize(ByteBuffer keyBuffer, ByteBuffer valueBuffer) throws RuntimeException {
        ...
        return new Record(new ApiMessageAndVersion(keyMessage, recordType), new ApiMessageAndVersion(valueMessage, valueVersion));
    }
