...
public interface CoordinatorBuilder<S extends Coordinator<U>, U> {
     ...
     * @return The builder.
     */
    CoordinatorBuilder<S, U> withSnapshotRegistry(SnapshotRegistry snapshotRegistry);
     ...
     * @return The builder.
     */
    CoordinatorBuilder<S, U> withLogContext(LogContext logContext);
     ...
     * @return The builder.
     */
    CoordinatorBuilder<S, U> withTime(Time time);
     ...
     * @return The builder.
     */
    CoordinatorBuilder<S, U> withTimer(CoordinatorTimer<U> timer);
