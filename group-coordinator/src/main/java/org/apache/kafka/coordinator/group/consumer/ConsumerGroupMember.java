...
public class ConsumerGroupMember {
    ...
    public static class Builder {
        ...
        public Builder updateWith(ConsumerGroupMemberMetadataValue record) {
            ...
            setClientAssignors(record.assignors().stream().map(ClientAssignor::fromRecord).collect(Collectors.toList()));
            return this;
        }
        ...
        private Map<Uuid, Set<Integer>> assignmentFromTopicPartitions(List<ConsumerGroupCurrentMemberAssignmentValue.TopicPartitions> topicPartitionsList) {
            return topicPartitionsList.stream().collect(Collectors.toMap(ConsumerGroupCurrentMemberAssignmentValue.TopicPartitions::topicId, topicPartitions -> Collections.unmodifiableSet(new HashSet<>(topicPartitions.partitions()))));
        }
        ...
        public ConsumerGroupMember build() {
            ...
            return new ConsumerGroupMember(memberId, memberEpoch, previousMemberEpoch, targetMemberEpoch, instanceId, rackId, rebalanceTimeoutMs, clientId, clientHost, subscribedTopicNames, subscribedTopicRegex, serverAssignorName, clientAssignors, state, assignedPartitions, partitionsPendingRevocation, partitionsPendingAssignment);
        }
    }
    ...
    public enum MemberState {
        REVOKING("revoking"), ASSIGNING("assigning"), STABLE("stable");
    ...
    public String currentAssignmentSummary() {
        return "CurrentAssignment(memberEpoch=" + memberEpoch + ", previousMemberEpoch=" + previousMemberEpoch + ", targetMemberEpoch=" + targetMemberEpoch + ", state=" + state + ", assignedPartitions=" + assignedPartitions + ", partitionsPendingRevocation=" + partitionsPendingRevocation + ", partitionsPendingAssignment=" + partitionsPendingAssignment + ')';
    }
    ...
    public boolean equals(Object o) {
        ...
        return memberEpoch == that.memberEpoch && previousMemberEpoch == that.previousMemberEpoch && targetMemberEpoch == that.targetMemberEpoch && rebalanceTimeoutMs == that.rebalanceTimeoutMs && Objects.equals(memberId, that.memberId) && Objects.equals(instanceId, that.instanceId) && Objects.equals(rackId, that.rackId) && Objects.equals(clientId, that.clientId) && Objects.equals(clientHost, that.clientHost) && Objects.equals(subscribedTopicNames, that.subscribedTopicNames) && Objects.equals(subscribedTopicRegex, that.subscribedTopicRegex) && Objects.equals(serverAssignorName, that.serverAssignorName) && Objects.equals(clientAssignors, that.clientAssignors) && Objects.equals(assignedPartitions, that.assignedPartitions) && Objects.equals(partitionsPendingRevocation, that.partitionsPendingRevocation) && Objects.equals(partitionsPendingAssignment, that.partitionsPendingAssignment);
    }
    ...
    @Override
    public String toString() {
        return "ConsumerGroupMember(" + "memberId='" + memberId + '\'' + ", memberEpoch=" + memberEpoch + ", previousMemberEpoch=" + previousMemberEpoch + ", targetMemberEpoch=" + targetMemberEpoch + ", instanceId='" + instanceId + '\'' + ", rackId='" + rackId + '\'' + ", rebalanceTimeoutMs=" + rebalanceTimeoutMs + ", clientId='" + clientId + '\'' + ", clientHost='" + clientHost + '\'' + ", subscribedTopicNames=" + subscribedTopicNames + ", subscribedTopicRegex='" + subscribedTopicRegex + '\'' + ", serverAssignorName='" + serverAssignorName + '\'' + ", clientAssignors=" + clientAssignors + ", state=" + state + ", assignedPartitions=" + assignedPartitions + ", partitionsPendingRevocation=" + partitionsPendingRevocation + ", partitionsPendingAssignment=" + partitionsPendingAssignment + ')';
    }
}
