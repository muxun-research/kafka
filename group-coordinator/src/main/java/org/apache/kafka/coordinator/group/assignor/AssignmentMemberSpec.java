...
public class AssignmentMemberSpec {
    ...
    public boolean equals(Object o) {
        ...
        if (!rackId.equals(that.rackId))
            return false;
        if (!subscribedTopicIds.equals(that.subscribedTopicIds))
            return false;
    ...
    public String toString() {
        return "AssignmentMemberSpec(instanceId=" + instanceId + ", rackId=" + rackId + ", subscribedTopicIds=" + subscribedTopicIds + ", assignedPartitions=" + assignedPartitions + ')';
    }
}
