...
public class ClientAssignor {
    ...
    public boolean equals(Object o) {
        ...
        if (reason != that.reason)
            return false;
        if (minimumVersion != that.minimumVersion)
            return false;
        if (maximumVersion != that.maximumVersion)
            return false;
    ...
    public String toString() {
        return "ClientAssignor(name=" + name + ", reason=" + reason + ", minimumVersion=" + minimumVersion + ", maximumVersion=" + maximumVersion + ", metadata=" + metadata + ')';
    }
