...
public class TimelineHashSetTest {
    ...
    public void testIteration() {
        ...
        assertThat(TimelineHashMapTest.iteratorToList(set.iterator(2)), containsInAnyOrder("a", "b", "c"));
        assertThat(TimelineHashMapTest.iteratorToList(set.iterator()), containsInAnyOrder("a", "b"));
    ...
    public void testSetMethods() {
        ...
        assertThat(TimelineHashMapTest.iteratorToList(set.iterator(5)), containsInAnyOrder("abc", "jkl"));
        assertThat(TimelineHashMapTest.iteratorToList(set.iterator()), containsInAnyOrder("abc", "jkl"));
        set.removeIf(e -> e.startsWith("a"));
        assertThat(TimelineHashMapTest.iteratorToList(set.iterator()), containsInAnyOrder("jkl"));
        assertThat(TimelineHashMapTest.iteratorToList(set.iterator(5)), containsInAnyOrder("abc", "jkl"));
    }
}
