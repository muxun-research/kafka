...
class KafkaYammerMetricsTest {
    ...
    public void testUntaggedMetric() {
        ...
        assertEquals("kafka.metrics:type=TestMetrics,name=UntaggedMetric", metricName.getMBeanName());
    ...
    public void testTaggedMetricName() {
        ...
        MetricName metricName = KafkaYammerMetrics.getMetricName("kafka.metrics", "TestMetrics", "TaggedMetric", tags);
        ...
        assertEquals("kafka.metrics:type=TestMetrics,name=TaggedMetric,foo=bar,bar=baz,baz=raz.taz", metricName.getMBeanName());
    ...
    public void testTaggedMetricNameWithEmptyValue() {
        ...
        assertEquals("kafka.metrics:type=TestMetrics,name=TaggedMetric,foo=bar,baz=raz.taz", metricName.getMBeanName());
