...
public abstract class DelegationChecker<D, W, T> {
    ...
    public void doVoidMethodDelegationCheck() {
        if (mockConsumer == null || wrapperConsumer == null || mockConfigurationFunction != null || wrapperFunctionApplier != null || mockFunctionReturnValue != null || mockFunctionReturnValueTransformation != null) {
    ...
    public void doUnsupportedVoidFunctionDelegationCheck() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> wrapperConsumer.accept(wrapper), "Expected to Throw UnsupportedOperationException");
    }

    @SuppressWarnings("unchecked")
    public void doFunctionDelegationCheck() {
        if (mockConfigurationFunction == null || wrapperFunctionApplier == null || mockFunctionReturnValueTransformation == null || mockConsumer != null || wrapperConsumer != null) {
            throwExceptionForIllegalTestSetup();
        }
        // configure the mock to behave as desired
    ...
    public void doUnsupportedFunctionDelegationCheck() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> wrapperFunctionApplier.apply(wrapper), "Expected to Throw UnsupportedOperationException");
    }
