...
public class BoundedList<E> implements List<E> {
    ...
    public boolean add(E e) {
        if (underlying.size() >= maxLength) {
            throw new BoundedListTooLongException("Cannot add another element to the list " + "because it would exceed the maximum length of " + maxLength);
        }
    ...
    public boolean addAll(Collection<? extends E> c) {
        ...
        if (underlying.size() > maxLength - numToAdd) {
            throw new BoundedListTooLongException("Cannot add another " + numToAdd + " element(s) to the list because it would exceed the maximum length of " + maxLength);
        }
