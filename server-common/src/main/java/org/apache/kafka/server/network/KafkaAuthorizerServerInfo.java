...
public final class KafkaAuthorizerServerInfo implements AuthorizerServerInfo {
    ...
    public boolean equals(Object o) {
        ...
        return clusterResource.equals(other.clusterResource) && brokerId == other.brokerId && endpoints.equals(other.endpoints) && interbrokerEndpoint.equals(other.interbrokerEndpoint) && earlyStartListeners.equals(other.earlyStartListeners);
    }

    @Override
    public int hashCode() {
        return Objects.hash(clusterResource, brokerId, endpoints, interbrokerEndpoint, earlyStartListeners);
    }

    @Override
    public String toString() {
        return "KafkaAuthorizerServerInfo(" + "clusterResource=" + clusterResource + ", brokerId=" + brokerId + ", endpoints=" + endpoints + ", earlyStartListeners=" + earlyStartListeners + ")";
    }
}
