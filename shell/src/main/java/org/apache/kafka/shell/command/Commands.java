...
public final class Commands {
    ...
    public interface Handler {
        void run(Optional<InteractiveShell> shell, PrintWriter writer, MetadataShellState state) throws Exception;
    }
    ...
    public interface Type {
        ...
        void completeNext(MetadataShellState nodeManager, List<String> nextWords, List<Candidate> candidates) throws Exception;
    }
