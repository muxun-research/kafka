...
public final class ExitCommandHandler implements Commands.Handler {
    ...
    public static class ExitCommandType implements Commands.Type {
        ...
        @Override
        public void completeNext(MetadataShellState nodeManager, List<String> nextWords, List<Candidate> candidates) throws Exception {
            // nothing to do
        }
    }
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ExitCommandHandler))
            return false;
        return true;
    }
}
