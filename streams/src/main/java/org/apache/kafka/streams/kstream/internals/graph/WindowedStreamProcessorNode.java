...
public class WindowedStreamProcessorNode<K, V> extends ProcessorGraphNode<K, V> {
     ...
     */
    public WindowedStreamProcessorNode(final String windowStoreName, final ProcessorParameters<K, V, ?, ?> processorParameters) {
    ...
    public String toString() {
        return "WindowedStreamProcessorNode{" + "storeName=" + windowStoreName + "} " + super.toString();
    }
}
