...
public class TaskMetadataImpl implements TaskMetadata {
    ...
    public TaskMetadataImpl(final TaskId taskId, final Set<TopicPartition> topicPartitions, final Map<TopicPartition, Long> committedOffsets, final Map<TopicPartition, Long> endOffsets, final Optional<Long> timeCurrentIdlingStarted) {
        this.taskId = taskId;
