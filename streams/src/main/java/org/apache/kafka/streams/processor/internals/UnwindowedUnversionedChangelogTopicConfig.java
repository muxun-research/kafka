...
public class UnwindowedUnversionedChangelogTopicConfig extends InternalTopicConfig {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(name, that.name) && Objects.equals(topicConfigs, that.topicConfigs) && Objects.equals(enforceNumberOfPartitions, that.enforceNumberOfPartitions);
    }
    ...
    public String toString() {
        return "UnwindowedUnversionedChangelogTopicConfig(" + "name=" + name + ", topicConfigs=" + topicConfigs + ", enforceNumberOfPartitions=" + enforceNumberOfPartitions + ")";
    }
}
