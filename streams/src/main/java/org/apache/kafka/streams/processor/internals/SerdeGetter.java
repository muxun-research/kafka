...
public class SerdeGetter {
    ...
    public Serde keySerde() {
        return oldProcessorContext != null ? oldProcessorContext.keySerde() : newProcessorContext != null ? newProcessorContext.keySerde() : stateStorecontext.keySerde();
    }

    public Serde valueSerde() {
        return oldProcessorContext != null ? oldProcessorContext.valueSerde() : newProcessorContext != null ? newProcessorContext.valueSerde() : stateStorecontext.valueSerde();
    }
