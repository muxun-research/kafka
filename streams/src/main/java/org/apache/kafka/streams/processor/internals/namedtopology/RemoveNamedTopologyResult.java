...
public class RemoveNamedTopologyResult {
    ...
    public RemoveNamedTopologyResult(final KafkaFutureImpl<Void> removeTopologyFuture, final String removedTopology, final Runnable resetOffsets) {
        Objects.requireNonNull(removeTopologyFuture);
        this.removeTopologyFuture = removeTopologyFuture;
    ...
    private static class ResetOffsetsFuture extends KafkaFutureImpl<Void> {
        ...
        public ResetOffsetsFuture(final String removedTopology, final KafkaFutureImpl<Void> removeTopologyFuture, final Runnable resetOffsets) {
        ...
        public Void get() throws ExecutionException {
            ...
            try {
                ...
                log.error("Failed to reset offsets, you should do so manually if you want to add new topologies" + "in the future that consume from the same input topics");
                firstError.compareAndSet(e, null);
            }
