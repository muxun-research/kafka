...
public class TopicPartitionMetadata {
        ...
        try {
            ...
            switch (version) {
                ...
                case LATEST_MAGIC_BYTE:
                    ...
                    break;
                default:
                    LOG.warn("Unsupported offset metadata version found. Supported version <= {}. Found version {}.", LATEST_MAGIC_BYTE, version);
            }
    ...
    public boolean equals(final Object obj) {
        ...
        return partitionTime == ((TopicPartitionMetadata) obj).partitionTime && Objects.equals(processorMetadata, ((TopicPartitionMetadata) obj).processorMetadata);
    }
}
