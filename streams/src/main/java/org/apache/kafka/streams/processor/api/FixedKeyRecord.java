...
public final class FixedKeyRecord<K, V> {
    ...
    public String toString() {
        return "FixedKeyRecord{" + "key=" + key + ", value=" + value + ", timestamp=" + timestamp + ", headers=" + headers + '}';
    }
    ...
    public boolean equals(final Object o) {
        ...
        return timestamp == record.timestamp && Objects.equals(key, record.key) && Objects.equals(value, record.value) && Objects.equals(headers, record.headers);
    }
