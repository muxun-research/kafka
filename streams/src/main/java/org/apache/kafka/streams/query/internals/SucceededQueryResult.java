...
public final class SucceededQueryResult<R> extends AbstractQueryResult<R> implements QueryResult<R> {
     ...
     */
    SucceededQueryResult(final R result, final List<String> executionInfo, final Position position) {
    ...
    public String toString() {
        return "SucceededQueryResult{" + "result=" + result + ", executionInfo=" + getExecutionInfo() + ", position=" + getPosition() + '}';
    }
}
