 ...
 * {@link ThreadCache}
 */
public interface InternalProcessorContext<KOut, VOut> extends ProcessorContext, org.apache.kafka.streams.processor.api.ProcessorContext<KOut, VOut>, org.apache.kafka.streams.processor.api.FixedKeyProcessorContext<KOut, VOut>, StateStoreContext {
    ...
    void logChange(final String storeName, final Bytes key, final byte[] value, final long timestamp, final Position position);
