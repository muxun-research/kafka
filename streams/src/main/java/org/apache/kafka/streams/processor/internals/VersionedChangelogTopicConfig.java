...
public class VersionedChangelogTopicConfig extends InternalTopicConfig {
    ...
    VersionedChangelogTopicConfig(final String name, final Map<String, String> topicConfigs, final long minCompactionLagMs) {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(name, that.name) && Objects.equals(topicConfigs, that.topicConfigs) && Objects.equals(minCompactionLagMs, that.minCompactionLagMs) && Objects.equals(enforceNumberOfPartitions, that.enforceNumberOfPartitions);
    }
    ...
    public String toString() {
        return "VersionedChangelogTopicConfig(" + "name=" + name + ", topicConfigs=" + topicConfigs + ", minCompactionLagMs=" + minCompactionLagMs + ", enforceNumberOfPartitions=" + enforceNumberOfPartitions + ")";
    }
}