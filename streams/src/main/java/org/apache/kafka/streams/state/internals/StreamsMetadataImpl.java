...
public class StreamsMetadataImpl implements StreamsMetadata {
    ...
    public StreamsMetadataImpl(final HostInfo hostInfo, final Set<String> stateStoreNames, final Set<TopicPartition> topicPartitions, final Set<String> standbyStoreNames, final Set<TopicPartition> standbyTopicPartitions) {
        this(hostInfo, stateStoreNames, topicPartitions, standbyStoreNames, standbyTopicPartitions, null);
    }

    public StreamsMetadataImpl(final HostInfo hostInfo, final Set<String> stateStoreNames, final Set<TopicPartition> topicPartitions, final Set<String> standbyStoreNames, final Set<TopicPartition> standbyTopicPartitions, final String topologyName) {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(hostInfo, that.hostInfo) && Objects.equals(stateStoreNames, that.stateStoreNames) && Objects.equals(topicPartitions, that.topicPartitions) && Objects.equals(standbyStateStoreNames, that.standbyStateStoreNames) && Objects.equals(standbyTopicPartitions, that.standbyTopicPartitions) && Objects.equals(topologyName, that.topologyName);
    }
    ...
    public String toString() {
        final String str = "StreamsMetadata {" + "hostInfo=" + hostInfo + ", stateStoreNames=" + stateStoreNames + ", topicPartitions=" + topicPartitions + ", standbyStateStoreNames=" + standbyStateStoreNames + ", standbyTopicPartitions=" + standbyTopicPartitions;
        if (topologyName == null) {
            return str + '}';
        } else {
            return str + ", topologyName=" + topologyName + '}';
        }
    }
}
