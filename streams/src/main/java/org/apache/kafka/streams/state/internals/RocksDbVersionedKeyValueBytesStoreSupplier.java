...
public class RocksDbVersionedKeyValueBytesStoreSupplier implements VersionedBytesStoreSupplier {
    ...
    public RocksDbVersionedKeyValueBytesStoreSupplier(final String name, final long historyRetentionMs) {
        this(name, historyRetentionMs, defaultSegmentInterval(historyRetentionMs));
    }

    public RocksDbVersionedKeyValueBytesStoreSupplier(final String name, final long historyRetentionMs, final long segmentIntervalMs) {
        this.name = name;
    ...
    public KeyValueStore<Bytes, byte[]> get() {
        return new VersionedKeyValueToBytesStoreAdapter(new RocksDBVersionedStore(name, metricsScope(), historyRetentionMs, segmentIntervalMs));
    }
