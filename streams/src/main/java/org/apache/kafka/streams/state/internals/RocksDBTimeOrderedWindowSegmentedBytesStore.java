...
public class RocksDBTimeOrderedWindowSegmentedBytesStore extends AbstractRocksDBTimeOrderedSegmentedBytesStore {
    ...
    RocksDBTimeOrderedWindowSegmentedBytesStore(final String name, final String metricsScope, final long retention, final long segmentInterval, final boolean withIndex) {
        super(name, metricsScope, retention, segmentInterval, new TimeFirstWindowKeySchema(), Optional.ofNullable(withIndex ? new KeyFirstWindowKeySchema() : null));
    }
