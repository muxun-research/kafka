...
public class NamedCacheMetrics {
    ...
    public static Sensor hitRatioSensor(final StreamsMetricsImpl streamsMetrics, final String threadId, final String taskName, final String storeName) {

        final Sensor hitRatioSensor;
        final String hitRatioName;
        hitRatioName = HIT_RATIO;
        hitRatioSensor = streamsMetrics.cacheLevelSensor(threadId, taskName, storeName, hitRatioName, Sensor.RecordingLevel.DEBUG);
        addAvgAndMinAndMaxToSensor(hitRatioSensor, CACHE_LEVEL_GROUP, streamsMetrics.cacheLevelTagMap(threadId, taskName, storeName), hitRatioName, HIT_RATIO_AVG_DESCRIPTION, HIT_RATIO_MIN_DESCRIPTION, HIT_RATIO_MAX_DESCRIPTION);
