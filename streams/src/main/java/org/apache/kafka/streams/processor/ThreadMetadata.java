...
public class ThreadMetadata {
    ...
    public ThreadMetadata(final String threadName, final String threadState, final String mainConsumerClientId, final String restoreConsumerClientId, final Set<String> producerClientIds, final String adminClientId, final Set<org.apache.kafka.streams.processor.TaskMetadata> activeTasks, final Set<org.apache.kafka.streams.processor.TaskMetadata> standbyTasks) {
