...
public class KTableKTableForeignKeyVersionedJoinIntegrationTest extends KTableKTableForeignKeyJoinIntegrationTest {
    ...
    public KTableKTableForeignKeyVersionedJoinIntegrationTest(final boolean leftJoin, final boolean materialized, final boolean leftVersioned, final boolean rightVersioned) {
