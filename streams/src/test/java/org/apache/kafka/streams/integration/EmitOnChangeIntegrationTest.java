...
public class EmitOnChangeIntegrationTest {
    ...
    public void shouldEmitSameRecordAfterFailover() throws Exception {
        ...
        try (final KafkaStreams kafkaStreams = new KafkaStreams(builder.build(), properties)) {
            ...
            IntegrationTestUtils.produceKeyValuesSynchronouslyWithTimestamp(inputTopic2, Arrays.asList(new KeyValue<>(1, "A"), new KeyValue<>(1, "B")), TestUtils.producerConfig(CLUSTER.bootstrapServers(), IntegerSerializer.class, StringSerializer.class, new Properties()), 0L);
            ...
            IntegrationTestUtils.waitUntilFinalKeyValueRecordsReceived(TestUtils.consumerConfig(CLUSTER.bootstrapServers(), IntegerDeserializer.class, StringDeserializer.class), outputTopic2, Arrays.asList(new KeyValue<>(1, "A"), new KeyValue<>(1, "B")));
        }
    }
}
