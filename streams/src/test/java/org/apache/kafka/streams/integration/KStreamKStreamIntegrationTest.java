...
public class KStreamKStreamIntegrationTest {
    ...
    private void verifyKStreamKStreamOuterJoin(final Set<KeyValue<String, String>> expectedResult) throws Exception {
        ...
        final List<KeyValue<String, String>> left1 = asList(new KeyValue<>("Key-1", "left-1a"), new KeyValue<>("Key-2", "left-2a"), new KeyValue<>("Key-3", "left-3a"), new KeyValue<>("Key-4", "left-4a"));

        final List<KeyValue<String, String>> left2 = asList(new KeyValue<>("Key-1", "left-1b"), new KeyValue<>("Key-2", "left-2b"), new KeyValue<>("Key-3", "left-3b"), new KeyValue<>("Key-4", "left-4b"));
