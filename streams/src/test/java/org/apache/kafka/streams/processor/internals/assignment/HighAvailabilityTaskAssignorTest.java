...
public class HighAvailabilityTaskAssignorTest {
    ...
    public void shouldBeStickyForActiveAndStandbyTasksWhileWarmingUp() {
        ...
        final boolean unstable = new HighAvailabilityTaskAssignor().assign(clientStates, allTaskIds, allTaskIds, new AssignmentConfigs(11L, 2, 1, 60_000L, EMPTY_RACK_AWARE_ASSIGNMENT_TAGS));
    ...
    public void shouldSkipWarmupsWhenAcceptableLagIsMax() {
        ...
        final boolean unstable = new HighAvailabilityTaskAssignor().assign(clientStates, allTaskIds, allTaskIds, new AssignmentConfigs(Long.MAX_VALUE, 1, 1, 60_000L, EMPTY_RACK_AWARE_ASSIGNMENT_TAGS));
    ...
    public void shouldAssignActiveStatefulTasksEvenlyOverClientsWhereNumberOfClientsIntegralDivisorOfNumberOfTasks() {
        ...
        final boolean unstable = new HighAvailabilityTaskAssignor().assign(clientStates, allTaskIds, allTaskIds, new AssignmentConfigs(0L, 1, 0, 60_000L, EMPTY_RACK_AWARE_ASSIGNMENT_TAGS));
        assertThat(unstable, is(false));
    ...
    public void shouldAssignWarmUpTasksIfStatefulActiveTasksBalancedOverStreamThreadsButNotOverClients() {
        ...
        final boolean unstable = new HighAvailabilityTaskAssignor().assign(clientStates, allTaskIds, allTaskIds, new AssignmentConfigs(0L, allTaskIds.size() / 3 + 1, 0, 60_000L, EMPTY_RACK_AWARE_ASSIGNMENT_TAGS));
    ...
    public void shouldComputeNewAssignmentIfActiveTasksWasNotOnCaughtUpClient() {
        ...
        final boolean probingRebalanceNeeded = new HighAvailabilityTaskAssignor().assign(clientStates, allTasks, statefulTasks, configWithoutStandbys);
    ...
    public void shouldAssignToMostCaughtUpIfActiveTasksWasNotOnCaughtUpClient() {
        ...
        final Map<UUID, ClientState> clientStates = mkMap(mkEntry(UUID_1, client1), mkEntry(UUID_2, client2), mkEntry(UUID_3, client3));
    ...
    public void shouldNotAssignMoreThanMaxWarmupReplicas() {
        ...
        final Map<UUID, ClientState> clientStates = getClientStatesMap(client1, client2);
        final boolean probingRebalanceNeeded = new HighAvailabilityTaskAssignor().assign(clientStates, allTasks, statefulTasks, new AssignmentConfigs(
                /*acceptableRecoveryLag*/ 100L,
                /*maxWarmupReplicas*/ 1,
                /*numStandbyReplicas*/ 0,
                /*probingRebalanceIntervalMs*/ 60 * 1000L,
    ...
    public void shouldNotAssignMoreThanMaxWarmupReplicasWithStandbys() {
        ...
        assertValidAssignment(1, 2, statefulTasks, emptySet(), clientStates, new StringBuilder());
        assertThat(probingRebalanceNeeded, is(true));
    }
    ...
    public void shouldDistributeStatelessTasksToBalanceTotalTaskLoad() {
        ...
        final boolean probingRebalanceNeeded = new HighAvailabilityTaskAssignor().assign(clientStates, allTasks, statefulTasks, configWithStandbys);
        assertValidAssignment(1, 2, statefulTasks, statelessTasks, clientStates, new StringBuilder());
        assertBalancedActiveAssignment(clientStates, new StringBuilder());
    ...
    public void shouldDistributeStatefulActiveTasksToAllClients() {
        final Set<TaskId> allTasks = mkSet(TASK_0_0, TASK_0_1, TASK_0_2, TASK_0_3, TASK_1_0, TASK_1_1, TASK_1_2, TASK_1_3, TASK_2_0); // 9 total
    ...
    public void shouldDistributeStatelessTasksEvenlyOverClientsWithEqualStreamThreadsPerClientAsTasksAndNoStatefulTasks() {
        ...
        final boolean probingRebalanceNeeded = new HighAvailabilityTaskAssignor().assign(clientStates, allTasks, statefulTasks, new AssignmentConfigs(0L, 1, 0, 60_000L, EMPTY_RACK_AWARE_ASSIGNMENT_TAGS));
    ...
    private static ClientState getMockClientWithPreviousCaughtUpTasks(final Set<TaskId> statefulActiveTasks, final Set<TaskId> statefulTasks) {
