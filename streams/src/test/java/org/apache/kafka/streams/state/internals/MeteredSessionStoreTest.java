...
public class MeteredSessionStoreTest {
    ...
    public void shouldDelegateDeprecatedInit() {
        ...
        final MeteredSessionStore<String, String> outer = new MeteredSessionStore<>(inner, STORE_TYPE, Serdes.String(), Serdes.String(), new MockTime());
    ...
    private void doShouldPassChangelogTopicNameToStateStoreSerde(final String topic) {
        ...
        store = new MeteredSessionStore<>(innerStore, STORE_TYPE, keySerde, valueSerde, new MockTime());
        store.init((StateStoreContext) context, store);
    ...
    public void shouldBackwardFindSessionsFromStoreAndRecordFetchMetric() {
        expect(innerStore.backwardFindSessions(KEY_BYTES, 0, 0)).andReturn(new KeyValueIteratorStub<>(Collections.singleton(KeyValue.pair(WINDOWED_KEY_BYTES, VALUE_BYTES)).iterator()));
        init();
    ...
    public void shouldBackwardFindSessionRangeFromStoreAndRecordFetchMetric() {
        expect(innerStore.backwardFindSessions(KEY_BYTES, KEY_BYTES, 0, 0)).andReturn(new KeyValueIteratorStub<>(Collections.singleton(KeyValue.pair(WINDOWED_KEY_BYTES, VALUE_BYTES)).iterator()));
        init();
    ...
    public void shouldBackwardFetchForKeyAndRecordFetchMetric() {
        expect(innerStore.backwardFetch(KEY_BYTES)).andReturn(new KeyValueIteratorStub<>(Collections.singleton(KeyValue.pair(WINDOWED_KEY_BYTES, VALUE_BYTES)).iterator()));
        init();
    ...
    public void shouldReturnNoSessionsWhenFetchedKeyHasExpired() {
        ...
        expect(innerStore.findSessions(KEY_BYTES, systemTime - RETENTION_PERIOD, systemTime)).andReturn(new KeyValueIteratorStub<>(KeyValueIterators.emptyIterator()));
        init();
    ...
    public void shouldReturnNoSessionsInBackwardOrderWhenFetchedKeyHasExpired() {
        final long systemTime = Time.SYSTEM.milliseconds();
        expect(innerStore.backwardFindSessions(KEY_BYTES, systemTime - RETENTION_PERIOD, systemTime)).andReturn(new KeyValueIteratorStub<>(KeyValueIterators.emptyIterator()));
        init();
    ...
    public void shouldNotFindExpiredSessionRangeFromStore() {
        final long systemTime = Time.SYSTEM.milliseconds();
        expect(innerStore.findSessions(KEY_BYTES, KEY_BYTES, systemTime - RETENTION_PERIOD, systemTime)).andReturn(new KeyValueIteratorStub<>(KeyValueIterators.emptyIterator()));
        init();
    ...
    public void shouldNotFindExpiredSessionRangeInBackwardOrderFromStore() {
        final long systemTime = Time.SYSTEM.milliseconds();
        expect(innerStore.backwardFindSessions(KEY_BYTES, KEY_BYTES, systemTime - RETENTION_PERIOD, systemTime)).andReturn(new KeyValueIteratorStub<>(KeyValueIterators.emptyIterator()));
        init();
    ...
    public void shouldSetFlushListenerOnWrappedCachingStore() {
        ...
        store = new MeteredSessionStore<>(cachedSessionStore, STORE_TYPE, Serdes.String(), Serdes.String(), new MockTime());
