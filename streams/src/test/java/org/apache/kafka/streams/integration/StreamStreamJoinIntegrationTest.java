...
public class StreamStreamJoinIntegrationTest extends AbstractJoinIntegrationTest {
    ...
    public void testSelfJoin() {
        ...
        final List<List<TestRecord<Long, String>>> expectedResult = Arrays.asList(null, Collections.singletonList(new TestRecord<>(ANY_UNIQUE_KEY, "A-A", null, 2L)), Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "B-A", null, 3L), new TestRecord<>(ANY_UNIQUE_KEY, "A-B", null, 3L), new TestRecord<>(ANY_UNIQUE_KEY, "B-B", null, 3L)), null, Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "C-A", null, 5L), new TestRecord<>(ANY_UNIQUE_KEY, "C-B", null, 5L), new TestRecord<>(ANY_UNIQUE_KEY, "A-C", null, 5L), new TestRecord<>(ANY_UNIQUE_KEY, "B-C", null, 5L), new TestRecord<>(ANY_UNIQUE_KEY, "C-C", null, 5L)), null, Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "D-A", null, 7L), new TestRecord<>(ANY_UNIQUE_KEY, "D-B", null, 7L), new TestRecord<>(ANY_UNIQUE_KEY, "D-C", null, 7L), new TestRecord<>(ANY_UNIQUE_KEY, "A-D", null, 7L), new TestRecord<>(ANY_UNIQUE_KEY, "B-D", null, 7L), new TestRecord<>(ANY_UNIQUE_KEY, "C-D", null, 7L), new TestRecord<>(ANY_UNIQUE_KEY, "D-D", null, 7L)));

        leftStream.join(leftStream, valueJoiner, JoinWindows.ofTimeDifferenceAndGrace(ofSeconds(10), ofHours(24))).to(OUTPUT_TOPIC);
    ...
    public void testInner() {
        ...
        final List<List<TestRecord<Long, String>>> expectedResult = Arrays.asList(null, null, null, Collections.singletonList(new TestRecord<>(ANY_UNIQUE_KEY, "A-a", null, 4L)), Collections.singletonList(new TestRecord<>(ANY_UNIQUE_KEY, "B-a", null, 5L)), Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "A-b", null, 6L), new TestRecord<>(ANY_UNIQUE_KEY, "B-b", null, 6L)), null, null, Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "C-a", null, 9L), new TestRecord<>(ANY_UNIQUE_KEY, "C-b", null, 9L)), Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "A-c", null, 10L), new TestRecord<>(ANY_UNIQUE_KEY, "B-c", null, 10L), new TestRecord<>(ANY_UNIQUE_KEY, "C-c", null, 10L)), null, null, null, Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "A-d", null, 14L), new TestRecord<>(ANY_UNIQUE_KEY, "B-d", null, 14L), new TestRecord<>(ANY_UNIQUE_KEY, "C-d", null, 14L)), Arrays.asList(new TestRecord<>(ANY_UNIQUE_KEY, "D-a", null, 15L), new TestRecord<>(ANY_UNIQUE_KEY, "D-b", null, 15L), new TestRecord<>(ANY_UNIQUE_KEY, "D-c", null, 15L), new TestRecord<>(ANY_UNIQUE_KEY, "D-d", null, 15L)));

        leftStream.join(rightStream, valueJoiner, JoinWindows.ofTimeDifferenceAndGrace(ofSeconds(10), ofHours(24))).to(OUTPUT_TOPIC);
    ...
    public void testInnerRepartitioned() {
        ...
        leftStream.map(MockMapper.noOpKeyValueMapper()).join(rightStream.flatMap(MockMapper.noOpFlatKeyValueMapper()).selectKey(MockMapper.selectKeyKeyValueMapper()), valueJoiner, JoinWindows.ofTimeDifferenceAndGrace(ofSeconds(10), ofHours(24))).to(OUTPUT_TOPIC);
    ...
    public void testLeft() {
        ...
        leftStream.leftJoin(rightStream, valueJoiner, JoinWindows.ofTimeDifferenceAndGrace(ofSeconds(10), ofHours(24))).to(OUTPUT_TOPIC);
    ...
    public void testLeftRepartitioned() {
        ...
        leftStream.map(MockMapper.noOpKeyValueMapper()).leftJoin(rightStream.flatMap(MockMapper.noOpFlatKeyValueMapper()).selectKey(MockMapper.selectKeyKeyValueMapper()), valueJoiner, JoinWindows.ofTimeDifferenceAndGrace(ofSeconds(10), ofHours(24))).to(OUTPUT_TOPIC);
    ...
    public void testOuter() {
        ...
        leftStream.outerJoin(rightStream, valueJoiner, JoinWindows.ofTimeDifferenceAndGrace(ofSeconds(10), ofHours(24))).to(OUTPUT_TOPIC);
    ...
    public void testOuterRepartitioned() {
        ...
        leftStream.map(MockMapper.noOpKeyValueMapper()).outerJoin(rightStream.flatMap(MockMapper.noOpFlatKeyValueMapper()).selectKey(MockMapper.selectKeyKeyValueMapper()), valueJoiner, JoinWindows.ofTimeDifferenceAndGrace(ofSeconds(10), ofHours(24))).to(OUTPUT_TOPIC);
