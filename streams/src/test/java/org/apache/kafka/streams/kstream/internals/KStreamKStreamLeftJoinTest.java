...
public class KStreamKStreamLeftJoinTest {
    ...
    public void shouldNotEmitLeftJoinResultForAsymmetricWindow() {
        ...
        joined = stream1.leftJoin(stream2, MockValueJoiner.TOSTRING_JOINER, JoinWindows.ofTimeDifferenceWithNoGrace(ofMillis(100)).before(ZERO), StreamJoined.with(Serdes.Integer(), Serdes.String(), Serdes.String()));
        joined.process(supplier);
