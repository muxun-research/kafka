...
public class KStreamFlatTransformValuesTest {
    ...
    public void shouldTransformInputRecordToMultipleOutputValues() {
        final Iterable<String> outputValues = Arrays.asList("Hello", "Blue", "Planet");
    ...
    public void shouldGetFlatTransformValuesProcessor() {
        @SuppressWarnings("unchecked") final ValueTransformerWithKeySupplier<Integer, Integer, Iterable<String>> valueTransformerSupplier = mock(ValueTransformerWithKeySupplier.class);
