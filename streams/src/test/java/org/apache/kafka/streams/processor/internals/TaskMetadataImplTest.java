...
public class TaskMetadataImplTest {
    ...
    @Before
    public void setUp() {
        taskMetadata = new TaskMetadataImpl(TASK_ID, TOPIC_PARTITIONS, COMMITTED_OFFSETS, END_OFFSETS, TIME_CURRENT_IDLING_STARTED);
    }
    ...
    public void shouldBeEqualsIfSameObject() {
        final TaskMetadataImpl same = new TaskMetadataImpl(TASK_ID, TOPIC_PARTITIONS, COMMITTED_OFFSETS, END_OFFSETS, TIME_CURRENT_IDLING_STARTED);
    ...
    public void shouldBeEqualsIfOnlyDifferInCommittedOffsets() {
        final TaskMetadataImpl stillSameDifferCommittedOffsets = new TaskMetadataImpl(TASK_ID, TOPIC_PARTITIONS, mkMap(mkEntry(TP_1, 1000000L), mkEntry(TP_1, 2L)), END_OFFSETS, TIME_CURRENT_IDLING_STARTED);
    ...
    public void shouldBeEqualsIfOnlyDifferInEndOffsets() {
        final TaskMetadataImpl stillSameDifferEndOffsets = new TaskMetadataImpl(TASK_ID, TOPIC_PARTITIONS, COMMITTED_OFFSETS, mkMap(mkEntry(TP_1, 1000000L), mkEntry(TP_1, 2L)), TIME_CURRENT_IDLING_STARTED);
    ...
    public void shouldBeEqualsIfOnlyDifferInIdlingTime() {
        final TaskMetadataImpl stillSameDifferIdlingTime = new TaskMetadataImpl(TASK_ID, TOPIC_PARTITIONS, COMMITTED_OFFSETS, END_OFFSETS, Optional.empty());
    ...
    public void shouldNotBeEqualsIfDifferInTaskID() {
        final TaskMetadataImpl differTaskId = new TaskMetadataImpl(new TaskId(1, 10000), TOPIC_PARTITIONS, COMMITTED_OFFSETS, END_OFFSETS, TIME_CURRENT_IDLING_STARTED);
    ...
    public void shouldNotBeEqualsIfDifferInTopicPartitions() {
        final TaskMetadataImpl differTopicPartitions = new TaskMetadataImpl(TASK_ID, mkSet(TP_0), COMMITTED_OFFSETS, END_OFFSETS, TIME_CURRENT_IDLING_STARTED);
