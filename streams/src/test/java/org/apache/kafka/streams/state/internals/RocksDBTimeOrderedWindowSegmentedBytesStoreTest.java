...
public class RocksDBTimeOrderedWindowSegmentedBytesStoreTest extends AbstractDualSchemaRocksDBSegmentedBytesStoreTest<KeyValueSegment> {
    ...
    private enum SchemaType {
        WindowSchemaWithIndex, WindowSchemaWithoutIndex, SessionSchemaWithIndex, SessionSchemaWithoutIndex
    }
    ...
    public static Collection<Object[]> getKeySchema() {
        return asList(new Object[][]{{SchemaType.WindowSchemaWithIndex, true}, {SchemaType.WindowSchemaWithoutIndex, false}, {SchemaType.SessionSchemaWithIndex, true}, {SchemaType.SessionSchemaWithoutIndex, false}});
    }
    ...
    AbstractDualSchemaRocksDBSegmentedBytesStore<KeyValueSegment> getBytesStore() {
        switch (schemaType) {
            ...
            case WindowSchemaWithoutIndex:
                return new RocksDBTimeOrderedWindowSegmentedBytesStore(storeName, METRICS_SCOPE, retention, segmentInterval, hasIndex);
            case SessionSchemaWithIndex:
            case SessionSchemaWithoutIndex:
                return new RocksDBTimeOrderedSessionSegmentedBytesStore(storeName, METRICS_SCOPE, retention, segmentInterval, hasIndex);
            default:
