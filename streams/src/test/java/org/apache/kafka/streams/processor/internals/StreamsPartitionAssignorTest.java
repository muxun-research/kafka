...
public class StreamsPartitionAssignorTest {
    ...
    private final List<PartitionInfo> infos = asList(new PartitionInfo("topic1", 0, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic1", 1, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic1", 2, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic2", 0, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic2", 1, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic2", 2, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic3", 0, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic3", 1, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic3", 2, Node.noNode(), new Node[0], new Node[0]), new PartitionInfo("topic3", 3, Node.noNode(), new Node[0], new Node[0]));

    private final SubscriptionInfo defaultSubscriptionInfo = getInfo(UUID_1, EMPTY_TASKS, EMPTY_TASKS);

    private final Cluster metadata = new Cluster("cluster", Collections.singletonList(Node.noNode()), infos, emptySet(), emptySet());
    ...
    private void createMockTaskManager(final Set<TaskId> activeTasks, final Set<TaskId> standbyTasks) {
    ...
    private MockInternalTopicManager overwriteInternalTopicManagerWithMock(final boolean mockCreateInternalTopics) {
        final MockInternalTopicManager mockInternalTopicManager = new MockInternalTopicManager(time, new StreamsConfig(configProps()), mockClientSupplier.restoreConsumer, mockCreateInternalTopics);
    ...
    public static Collection<Object[]> parameters() {
        return asList(new Object[]{HighAvailabilityTaskAssignor.class}, new Object[]{StickyTaskAssignor.class}, new Object[]{FallbackPriorTaskAssignor.class});
    }
    ...
    public void shouldProduceStickyAndBalancedAssignmentWhenNothingChanges() {
        final List<TaskId> allTasks = asList(TASK_0_0, TASK_0_1, TASK_0_2, TASK_0_3, TASK_1_0, TASK_1_1, TASK_1_2, TASK_1_3);

        final Map<String, List<TaskId>> previousAssignment = mkMap(mkEntry(CONSUMER_1, asList(TASK_0_0, TASK_1_1, TASK_1_3)), mkEntry(CONSUMER_2, asList(TASK_0_3, TASK_1_0)), mkEntry(CONSUMER_3, asList(TASK_0_1, TASK_0_2, TASK_1_2)));
        ...
        assertEquivalentAssignment(previousAssignment, assignTasksToThreads(allTasks, true, consumers, state, new HashMap<>()));
    }

    @Test
    public void shouldProduceStickyAndBalancedAssignmentWhenNewTasksAreAdded() {
        final List<TaskId> allTasks = new ArrayList<>(asList(TASK_0_0, TASK_0_1, TASK_0_2, TASK_0_3, TASK_1_0, TASK_1_1, TASK_1_2, TASK_1_3));

        final Map<String, List<TaskId>> previousAssignment = mkMap(mkEntry(CONSUMER_1, new ArrayList<>(asList(TASK_0_0, TASK_1_1, TASK_1_3))), mkEntry(CONSUMER_2, new ArrayList<>(asList(TASK_0_3, TASK_1_0))), mkEntry(CONSUMER_3, new ArrayList<>(asList(TASK_0_1, TASK_0_2, TASK_1_2))));
        ...
        final Map<String, List<TaskId>> newAssignment = assignTasksToThreads(allTasks, true, consumers, state, new HashMap<>());
    ...
    public void shouldProduceMaximallyStickyAssignmentWhenMemberLeaves() {
        ...
        final Map<String, List<TaskId>> assignment = assignTasksToThreads(allTasks, true, consumers, state, new HashMap<>());
    ...
    public void shouldInterleaveTasksByGroupIdDuringNewAssignment() {
        final List<TaskId> allTasks = asList(TASK_0_0, TASK_0_1, TASK_0_2, TASK_0_3, TASK_1_0, TASK_1_1, TASK_1_2, TASK_2_0, TASK_2_1);

        final Map<String, List<TaskId>> assignment = mkMap(mkEntry(CONSUMER_1, new ArrayList<>(asList(TASK_0_0, TASK_0_3, TASK_1_2))), mkEntry(CONSUMER_2, new ArrayList<>(asList(TASK_0_1, TASK_1_0, TASK_2_0))), mkEntry(CONSUMER_3, new ArrayList<>(asList(TASK_0_2, TASK_1_1, TASK_2_1))));
        ...
        final Map<String, List<TaskId>> interleavedTaskIds = assignTasksToThreads(allTasks, true, consumers, state, new HashMap<>());
    ...
    public void testEagerSubscription() {
        ...
        final Set<TaskId> standbyTasks = mkSet(new TaskId(0, 2), new TaskId(1, 2), new TaskId(2, 2));
    ...
    public void testAssignEmptyMetadata() {
        ...
        final Cluster emptyMetadata = new Cluster("cluster", Collections.singletonList(Node.noNode()), emptySet(), emptySet(), emptySet());
        ...
        Map<String, Assignment> assignments = partitionAssignor.assign(emptyMetadata, new GroupSubscription(subscriptions)).groupAssignment();

        // check assigned partitions
        assertEquals(emptySet(), new HashSet<>(assignments.get("consumer10").partitions()));
        ...
        // check assigned partitions
        assertEquals(mkSet(mkSet(t1p0, t2p0, t1p0, t2p0, t1p1, t2p1, t1p2, t2p2)), mkSet(new HashSet<>(assignments.get("consumer10").partitions())));
    ...
    public void testAssignWithStandbyReplicasBalanceSparse() {
        ...
        for (final String consumerId : client1Consumers) {
            subscriptions.put(consumerId, new Subscription(topics, getInfo(UUID_1, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
        }
        for (final String consumerId : client2Consumers) {
            subscriptions.put(consumerId, new Subscription(topics, getInfo(UUID_2, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
        }
    ...
    public void testAssignWithStandbyReplicasBalanceDense() {
        ...
        subscriptions.put("consumer10", new Subscription(topics, getInfo(UUID_1, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
        subscriptions.put("consumer20", new Subscription(topics, getInfo(UUID_2, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
    ...
    public void testAssignWithStandbyReplicasBalanceWithStatelessTasks() {
        ...
        subscriptions.put("consumer10", new Subscription(topics, getInfo(UUID_1, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
        subscriptions.put("consumer11", new Subscription(topics, getInfo(UUID_1, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
        subscriptions.put("consumer20", new Subscription(topics, getInfo(UUID_2, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
        subscriptions.put("consumer21", new Subscription(topics, getInfo(UUID_2, EMPTY_TASKS, EMPTY_TASKS, USER_END_POINT).encode()));
    ...
    public void shouldGenerateTasksForAllCreatedPartitions() {
        ...
        final KStream<Object, Object> stream1 = streamsBuilder.stream("topic1")
        ...
        final KTable<Object, Long> table1 = streamsBuilder.table("topic3")
                // force creation of internal repartition topic
                .groupBy(KeyValue::new).count();
    ...
    public void shouldAddUserDefinedEndPointToSubscription() {
        ...
        final Subscription subscription = new Subscription(new ArrayList<>(topics), userData);
    ...
    public void shouldNotLoopInfinitelyOnMissingMetadataAndShouldNotCreateRelatedTasks() {
        ...
        final KStream<Object, Object> stream1 = streamsBuilder
                ...
                .selectKey((key, value) -> null).groupByKey()
        ...
        streamsBuilder
                ...
                .join(stream1, (ValueJoiner<Object, Object, Void>) (value1, value2) -> null, JoinWindows.of(ofMillis(0)));
    ...
    public void shouldUpdateClusterMetadataAndHostInfoOnAssignment() {
        final Map<HostInfo, Set<TopicPartition>> initialHostState = mkMap(mkEntry(new HostInfo("localhost", 9090), mkSet(t1p0, t1p1)), mkEntry(new HostInfo("otherhost", 9090), mkSet(t2p0, t2p1)));

        final Map<HostInfo, Set<TopicPartition>> newHostState = mkMap(mkEntry(new HostInfo("localhost", 9090), mkSet(t1p0, t1p1)), mkEntry(new HostInfo("newotherhost", 9090), mkSet(t2p0, t2p1)));
    ...
    public void shouldTriggerImmediateRebalanceOnHostInfoChange() {
        final Map<HostInfo, Set<TopicPartition>> oldHostState = mkMap(mkEntry(new HostInfo("localhost", 9090), mkSet(t1p0, t1p1)), mkEntry(new HostInfo("otherhost", 9090), mkSet(t2p0, t2p1)));

        final Map<HostInfo, Set<TopicPartition>> newHostState = mkMap(mkEntry(new HostInfo("newhost", 9090), mkSet(t1p0, t1p1)), mkEntry(new HostInfo("otherhost", 9090), mkSet(t2p0, t2p1)));
    ...
    public void shouldThrowKafkaExceptionIfReferenceContainerNotConfigured() {
        ...
        final KafkaException expected = assertThrows(KafkaException.class, () -> partitionAssignor.configure(config));
    ...
    public void shouldThrowKafkaExceptionIfReferenceContainerConfigIsNotTaskManagerInstance() {
        ...
        final KafkaException expected = assertThrows(KafkaException.class, () -> partitionAssignor.configure(config));
        assertThat(expected.getMessage(), equalTo("java.lang.String is not an instance of org.apache.kafka.streams.processor.internals.assignment.ReferenceContainer"));
    }
    ...
    public void shouldRequestCommittedOffsetsForPreexistingSourceChangelogs() {
        ...
        when(consumerClient.committed(changelogs)).thenReturn(changelogs.stream().collect(Collectors.toMap(tp -> tp, tp -> new OffsetAndMetadata(Long.MAX_VALUE))));
        ...
        public synchronized Map<Subtopology, TopicsInfo> subtopologyToTopicsInfo() {
            if (corruptedTopicGroups == null) {
                ...
                for (final Map.Entry<Subtopology, TopicsInfo> topicGroupEntry : super.subtopologyToTopicsInfo().entrySet()) {
                    ...
                    corruptedTopicGroups.put(topicGroupEntry.getKey(), new TopicsInfo(emptySet(), originalInfo.sourceTopics, originalInfo.repartitionSourceTopics, originalInfo.stateChangelogTopics));
                }
            }
    ...
    private void shouldEncodeAssignmentErrorIfPreVersionProbingSubscriptionAndFutureSubscriptionIsMixed(final int oldVersion) {
        subscriptions.put("consumer1", new Subscription(Collections.singletonList("topic1"), getInfoForOlderVersion(oldVersion, UUID_1, EMPTY_TASKS, EMPTY_TASKS).encode()));
        subscriptions.put("future-consumer", new Subscription(Collections.singletonList("topic1"), encodeFutureSubscription()));
        configureDefault();
    ...
    private static void assertEquivalentAssignment(final Map<String, List<TaskId>> thisAssignment, final Map<String, List<TaskId>> otherAssignment) {
    ...
    private static SubscriptionInfo getInfoForOlderVersion(final int version, final UUID processId, final Set<TaskId> prevTasks, final Set<TaskId> standbyTasks) {
        return new SubscriptionInfo(version, LATEST_SUPPORTED_VERSION, processId, null, getTaskOffsetSums(prevTasks, standbyTasks), (byte) 0, 0, EMPTY_CLIENT_TAGS);
    }
