...
public class WindowedStreamPartitionerTest {
    ...
    public void testCopartitioning() {
        ...
        @SuppressWarnings("deprecation") final org.apache.kafka.clients.producer.internals.DefaultPartitioner defaultPartitioner = new org.apache.kafka.clients.producer.internals.DefaultPartitioner();
        ...
        for (int k = 0; k < 10; k++) {
            ...
            for (int w = 1; w < 10; w++) {
                ...
                @SuppressWarnings("deprecation") final Integer actual = streamPartitioner.partition(topicName, windowedKey, value, infos.size());
