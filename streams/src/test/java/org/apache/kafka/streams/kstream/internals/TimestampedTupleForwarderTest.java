...
public class TimestampedTupleForwarderTest {
    ...
    private void setFlushListener(final boolean sendOldValues) {
        ...
        new TimestampedTupleForwarder<>(store, (org.apache.kafka.streams.processor.api.ProcessorContext<Object, Change<Object>>) null, flushListener, sendOldValues);
    ...
    private void shouldForwardRecordsIfWrappedStateStoreDoesNotCache(final boolean sendOldValues) {
        ...
        final TimestampedTupleForwarder<String, String> forwarder = new TimestampedTupleForwarder<>(store, (org.apache.kafka.streams.processor.api.ProcessorContext<String, Change<String>>) context, null, sendOldValues);
    ...
    public void shouldNotForwardRecordsIfWrappedStateStoreDoesCache() {
        ...
        final TimestampedTupleForwarder<String, String> forwarder = new TimestampedTupleForwarder<>(store, (org.apache.kafka.streams.processor.api.ProcessorContext<String, Change<String>>) context, null, false);
