...
public class AssignorConfigurationTest {
    ...
    public void configsShouldRejectZeroWarmups() {
        final ConfigException exception = assertThrows(ConfigException.class, () -> new AssignorConfiguration.AssignmentConfigs(1L, 0, 1, 1L, EMPTY_RACK_AWARE_ASSIGNMENT_TAGS));
