...
public class SlidingWindowsTest {
    ...
    public void equalsAndHashcodeShouldBeValidForPositiveCases() {
        ...
        verifyEquality(SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifference), ofMillis(grace)), SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifference), ofMillis(grace)));

        verifyEquality(SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifference), ofMillis(grace)), SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifference), ofMillis(grace)));

        verifyEquality(SlidingWindows.ofTimeDifferenceWithNoGrace(ofMillis(timeDifference)), SlidingWindows.ofTimeDifferenceWithNoGrace(ofMillis(timeDifference)));
    }
    ...
    public void equalsAndHashcodeShouldNotBeEqualForDifferentTimeDifference() {
        ...
        verifyInEquality(SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifferenceOne), ofMillis(grace)), SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifferenceTwo), ofMillis(grace)));
    }
    ...
    public void equalsAndHashcodeShouldNotBeEqualForDifferentGracePeriod() {
        ...
        verifyInEquality(SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifference), ofMillis(graceOne)), SlidingWindows.ofTimeDifferenceAndGrace(ofMillis(timeDifference), ofMillis(graceTwo)));
    }
}
