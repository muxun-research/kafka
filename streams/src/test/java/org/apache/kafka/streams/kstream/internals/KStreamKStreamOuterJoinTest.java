...
public class KStreamKStreamOuterJoinTest {
    ...
    public void shouldNotEmitLeftJoinResultForAsymmetricBeforeWindow() {
        ...
        joined = stream1.outerJoin(stream2, MockValueJoiner.TOSTRING_JOINER, JoinWindows.ofTimeDifferenceWithNoGrace(ofMillis(100)).before(ZERO), StreamJoined.with(Serdes.Integer(), Serdes.String(), Serdes.String()));
        joined.process(supplier);
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), PROPS)) {
            ...
            processor.checkAndClearProcessResult(new KeyValueTimestamp<>(0, "A0+a0", 100L));
            ...
            processor.checkAndClearProcessResult(new KeyValueTimestamp<>(1, "A1+null", 1L));
            ...
            processor.checkAndClearProcessResult(new KeyValueTimestamp<>(1, "null+a1", 102L));
            ...
            processor.checkAndClearProcessResult(new KeyValueTimestamp<>(2, "A2+a2", 103L));
        }
    }
    ...
    public void shouldNotEmitLeftJoinResultForAsymmetricAfterWindow() {
        ...
        joined = stream1.outerJoin(stream2, MockValueJoiner.TOSTRING_JOINER, JoinWindows.ofTimeDifferenceWithNoGrace(ofMillis(100)).after(ZERO), StreamJoined.with(Serdes.Integer(), Serdes.String(), Serdes.String()));
        joined.process(supplier);
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), PROPS)) {
            ...
            processor.checkAndClearProcessResult(new KeyValueTimestamp<>(1, "A1+a1", 1L));
            ...
            processor.checkAndClearProcessResult(new KeyValueTimestamp<>(0, "A0+null", 0L));
            ...
            processor.checkAndClearProcessResult(new KeyValueTimestamp<>(2, "A2+a2", 201L));
        }
    }
    ...
    public void shouldForwardCurrentHeaders() {
        ...
        try (final TopologyTestDriver driver = new TopologyTestDriver(builder.build(), PROPS)) {
            ...
            inputTopic1.pipeInput(new TestRecord<>(0, "A0", new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x1})}), 0L));
            inputTopic2.pipeInput(new TestRecord<>(1, "a0", new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x2})}), 0L));
            // bump stream-time to trigger outer-join results
            inputTopic2.pipeInput(new TestRecord<>(3, "dummy", new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x3})}), (long) 211));
            ...
            processor.checkAndClearProcessedRecords(new Record<>(1, "null+a0", 0L, new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x3})})), new Record<>(0, "A0+null", 0L, new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x3})})));

            // verifies joined duplicates are emitted
            inputTopic1.pipeInput(new TestRecord<>(2, "A2", new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x4})}), 200L));
            inputTopic2.pipeInput(new TestRecord<>(2, "a2", new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x5})}), 200L));

            processor.checkAndClearProcessedRecords(new Record<>(2, "A2+a2", 200L, new RecordHeaders(new Header[]{new RecordHeader("h", new byte[]{0x5})})));
        }
    }
