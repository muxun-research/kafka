...
public class RocksDBVersionedStoreSegmentValueFormatterTest {
    ...
    public static class ExpectedCasesTest {
        ...
        public void shouldCreateNewWithRecord() {
            ...
            final SegmentValue segmentValue = RocksDBVersionedStoreSegmentValueFormatter.newSegmentValueWithRecord(testCase.records.get(0).value, testCase.records.get(0).timestamp, testCase.nextTimestamp);
