...
public class UpdateFeaturesRequestTest {
    ...
    public void testUpdateFeaturesV0() {
        ...
        features.add(new UpdateFeaturesRequestData.FeatureUpdateKey().setFeature("foo").setMaxVersionLevel((short) 1).setAllowDowngrade(true));

        features.add(new UpdateFeaturesRequestData.FeatureUpdateKey().setFeature("bar").setMaxVersionLevel((short) 3));

        UpdateFeaturesRequest request = new UpdateFeaturesRequest(new UpdateFeaturesRequestData().setFeatureUpdates(features), UpdateFeaturesRequestData.LOWEST_SUPPORTED_VERSION);
    ...
    public void testUpdateFeaturesV1() {
        ...
        features.add(new UpdateFeaturesRequestData.FeatureUpdateKey().setFeature("foo").setMaxVersionLevel((short) 1).setUpgradeType(FeatureUpdate.UpgradeType.SAFE_DOWNGRADE.code()));
    ...
    public void testUpdateFeaturesV1OldBoolean() {
        ...
        UpdateFeaturesRequest request = new UpdateFeaturesRequest(new UpdateFeaturesRequestData().setFeatureUpdates(features), UpdateFeaturesRequestData.HIGHEST_SUPPORTED_VERSION);
        assertThrows(UnsupportedVersionException.class, request::serialize, "This should fail since allowDowngrade is not supported in v1 of this RPC");
    }
