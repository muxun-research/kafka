...
class TopicIdPartitionTest {
    ...
    private final TopicIdPartition topicIdPartitionWithNullTopic0 = new TopicIdPartition(topicId0, partition1, null);
    private final TopicIdPartition topicIdPartitionWithNullTopic1 = new TopicIdPartition(topicId0, new TopicPartition(null, partition1));
    ...
    private final TopicIdPartition topicIdPartitionWithNullTopic2 = new TopicIdPartition(topicId1, new TopicPartition(null, partition1));
    ...
    public void testHashCode() {
        assertEquals(Objects.hash(topicIdPartition0.topicId(), topicIdPartition0.topicPartition()), topicIdPartition0.hashCode());
        assertEquals(topicIdPartition0.hashCode(), topicIdPartition1.hashCode());

        assertEquals(Objects.hash(topicIdPartitionWithNullTopic0.topicId(), new TopicPartition(null, partition1)), topicIdPartitionWithNullTopic0.hashCode());
