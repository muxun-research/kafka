...
public class ByteBufferAccessorTest {
    ...
    public void testReadArray() {
        ...
        assertEquals("Error reading byte array of 3 byte(s): only 0 byte(s) available", assertThrows(RuntimeException.class, () -> accessor.readArray(3)).getMessage());
    }
    ...
    public void testReadString() {
        ...
        assertEquals("Error reading byte array of 2 byte(s): only 0 byte(s) available", assertThrows(RuntimeException.class, () -> accessor.readString(2)).getMessage());
    }
}
