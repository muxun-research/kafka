...
public class DeleteRecordsHandlerTest {
    ...
    public void testHandleSuccessfulResponse() {
        AdminApiHandler.ApiResult<TopicPartition, DeletedRecords> result = handleResponse(createResponse(emptyMap(), recordsToDelete.keySet()));
    ...
    public void testHandleRetriablePartitionTimeoutResponse() {
        ...
        AdminApiHandler.ApiResult<TopicPartition, DeletedRecords> result = handleResponse(createResponse(errorsByPartition));
    ...
    public void testHandleResponseSanityCheck() {
        ...
        AdminApiHandler.ApiResult<TopicPartition, DeletedRecords> result = handleResponse(createResponse(emptyMap(), recordsToDeleteMap.keySet()));
