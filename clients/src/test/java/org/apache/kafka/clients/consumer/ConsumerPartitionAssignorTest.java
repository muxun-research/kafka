...
public class ConsumerPartitionAssignorTest {
    ...
    public void shouldInstantiateAssignor() {
        List<ConsumerPartitionAssignor> assignors = getAssignorInstances(Collections.singletonList(StickyAssignor.class.getName()), Collections.emptyMap());
        assertTrue(assignors.get(0) instanceof StickyAssignor);
    }

    @Test
    public void shouldInstantiateListOfAssignors() {
        List<ConsumerPartitionAssignor> assignors = getAssignorInstances(Arrays.asList(StickyAssignor.class.getName(), CooperativeStickyAssignor.class.getName()), Collections.emptyMap());
        assertTrue(assignors.get(0) instanceof StickyAssignor);
    ...
    public void shouldThrowKafkaExceptionOnNonAssignor() {
        assertThrows(KafkaException.class, () -> getAssignorInstances(Collections.singletonList(String.class.getName()), Collections.emptyMap()));
    }

    @Test
    public void shouldThrowKafkaExceptionOnAssignorNotFound() {
        assertThrows(KafkaException.class, () -> getAssignorInstances(Collections.singletonList("Non-existent assignor"), Collections.emptyMap()));
    }

    @Test
    public void shouldInstantiateFromClassType() {
        List<String> classTypes = initConsumerConfigWithClassTypes(Collections.singletonList(StickyAssignor.class)).getList(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG);
    ...
    public void shouldInstantiateFromListOfClassTypes() {
        List<String> classTypes = initConsumerConfigWithClassTypes(Arrays.asList(StickyAssignor.class, CooperativeStickyAssignor.class)).getList(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG);
    ...
    public void shouldThrowKafkaExceptionOnListWithNonAssignorClassType() {
        List<String> classTypes = initConsumerConfigWithClassTypes(Arrays.asList(StickyAssignor.class, String.class)).getList(ConsumerConfig.PARTITION_ASSIGNMENT_STRATEGY_CONFIG);
    ...
    public void shouldThrowKafkaExceptionOnAssignorsWithSameName() {
        assertThrows(KafkaException.class, () -> getAssignorInstances(Arrays.asList(RangeAssignor.class.getName(), TestConsumerPartitionAssignor.class.getName()), Collections.emptyMap()));
    }

    @Test
    public void shouldBeConfigurable() {
        Map<String, Object> configs = Collections.singletonMap("key", "value");
        List<ConsumerPartitionAssignor> assignors = getAssignorInstances(Collections.singletonList(TestConsumerPartitionAssignor.class.getName()), configs);
