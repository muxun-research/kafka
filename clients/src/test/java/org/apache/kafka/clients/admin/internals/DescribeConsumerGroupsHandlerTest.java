...
public class DescribeConsumerGroupsHandlerTest {
    ...
    private final Set<CoordinatorKey> keys = groupIds.stream().map(CoordinatorKey::byGroupId).collect(Collectors.toSet());
