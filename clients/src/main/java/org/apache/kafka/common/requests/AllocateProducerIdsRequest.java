...
public class AllocateProducerIdsRequest extends AbstractRequest {
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e) {
        return new AllocateProducerIdsResponse(new AllocateProducerIdsResponseData().setThrottleTimeMs(throttleTimeMs).setErrorCode(Errors.forException(e).code()));
    }
    ...
    public static AllocateProducerIdsRequest parse(ByteBuffer buffer, short version) {
        return new AllocateProducerIdsRequest(new AllocateProducerIdsRequestData(new ByteBufferAccessor(buffer), version), version);
    }
}
