...
public class EnvVarConfigProvider implements ConfigProvider {
    ...
    public void configure(Map<String, ?> configs) {
        ...
        filteredEnvVarMap = envVarMap.entrySet().stream().filter(envVar -> envVarPattern.matcher(envVar.getKey()).matches()).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
    }
