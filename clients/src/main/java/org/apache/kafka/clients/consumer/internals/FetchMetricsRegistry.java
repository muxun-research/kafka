...
public class FetchMetricsRegistry {
    ...
    public FetchMetricsRegistry(Set<String> tags, String metricGrpPrefix) {
        ...
        this.recordsLagMax = new MetricNameTemplate("records-lag-max", groupName, "The maximum lag in terms of number of records for any partition in this window. NOTE: This is based on current offset and not committed offset", tags);
