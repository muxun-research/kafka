...
public interface CreateTopicPolicy extends Configurable, AutoCloseable {
    ...
    class RequestMetadata {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(topic, numPartitions, replicationFactor, replicasAssignments, configs);
        }
        ...
        public boolean equals(Object o) {
            ...
            return topic.equals(other.topic) && Objects.equals(numPartitions, other.numPartitions) && Objects.equals(replicationFactor, other.replicationFactor) && Objects.equals(replicasAssignments, other.replicasAssignments) && configs.equals(other.configs);
        }
