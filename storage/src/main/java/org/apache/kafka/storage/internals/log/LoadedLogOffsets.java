...
public class LoadedLogOffsets {
    ...
    public LoadedLogOffsets(final long logStartOffset, final long recoveryPoint, final LogOffsetMetadata nextOffsetMetadata) {
    ...
    public boolean equals(Object o) {
        ...
        return logStartOffset == that.logStartOffset && recoveryPoint == that.recoveryPoint && nextOffsetMetadata.equals(that.nextOffsetMetadata);
    }
    ...
    public String toString() {
        return "LoadedLogOffsets(" + "logStartOffset=" + logStartOffset + ", recoveryPoint=" + recoveryPoint + ", nextOffsetMetadata=" + nextOffsetMetadata + ')';
    }
}
