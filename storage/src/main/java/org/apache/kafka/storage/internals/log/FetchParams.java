...
public class FetchParams {
    ...
    public boolean equals(Object o) {
        ...
        return requestVersion == that.requestVersion && replicaId == that.replicaId && replicaEpoch == that.replicaEpoch && maxWaitMs == that.maxWaitMs && minBytes == that.minBytes && maxBytes == that.maxBytes && isolation.equals(that.isolation) && clientMetadata.equals(that.clientMetadata);
    }
    ...
    public String toString() {
        return "FetchParams(" + "requestVersion=" + requestVersion + ", replicaId=" + replicaId + ", replicaEpoch=" + replicaEpoch + ", maxWaitMs=" + maxWaitMs + ", minBytes=" + minBytes + ", maxBytes=" + maxBytes + ", isolation=" + isolation + ", clientMetadata=" + clientMetadata + ')';
    }
}
