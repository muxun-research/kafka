...
public class LogOffsetSnapshot {
    ...
    public boolean equals(Object o) {
        ...
        return logStartOffset == that.logStartOffset && Objects.equals(logEndOffset, that.logEndOffset) && Objects.equals(highWatermark, that.highWatermark) && Objects.equals(lastStableOffset, that.lastStableOffset);
    }
    ...
    public String toString() {
        return "LogOffsetSnapshot(" + "logStartOffset=" + logStartOffset + ", logEndOffset=" + logEndOffset + ", highWatermark=" + highWatermark + ", lastStableOffset=" + lastStableOffset + ')';
    }
}
