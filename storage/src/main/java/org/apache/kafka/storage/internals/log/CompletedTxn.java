...
public class CompletedTxn {
    ...
    public boolean equals(Object o) {
        ...
        return producerId == that.producerId && firstOffset == that.firstOffset && lastOffset == that.lastOffset && isAborted == that.isAborted;
    }
    ...
    public String toString() {
        return "CompletedTxn(producerId=" + producerId + ", firstOffset=" + firstOffset + ", lastOffset=" + lastOffset + ", isAborted=" + isAborted + ')';
    }
}
