...
public final class LastRecord {
    ...
    public boolean equals(Object o) {
        ...
        return producerEpoch == that.producerEpoch && lastDataOffset.equals(that.lastDataOffset);
    }
    ...
    public String toString() {
        return "LastRecord(" + "lastDataOffset=" + lastDataOffset + ", producerEpoch=" + producerEpoch + ')';
    }
}
