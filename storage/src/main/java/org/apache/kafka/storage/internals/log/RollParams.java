...
public class RollParams {
    ...
    public String toString() {
        return "RollParams(" + "maxSegmentMs=" + maxSegmentMs + ", maxSegmentBytes=" + maxSegmentBytes + ", maxTimestampInMessages=" + maxTimestampInMessages + ", maxOffsetInMessages=" + maxOffsetInMessages + ", messagesSize=" + messagesSize + ", now=" + now + ')';
    }
