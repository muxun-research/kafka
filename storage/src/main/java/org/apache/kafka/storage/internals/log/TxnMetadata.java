...
public final class TxnMetadata {
    ...
    public TxnMetadata(long producerId, LogOffsetMetadata firstOffset, OptionalLong lastOffset) {
    ...
    public String toString() {
        return "TxnMetadata(" + "producerId=" + producerId + ", firstOffset=" + firstOffset + ", lastOffset=" + lastOffset + ')';
    }
}
