...
public class MetadataRequestBenchmark {
    ...
    private ZkMetadataCache metadataCache = MetadataCache.zkMetadataCache(brokerId, MetadataVersion.latest(), BrokerFeatures.createEmpty(), null);
